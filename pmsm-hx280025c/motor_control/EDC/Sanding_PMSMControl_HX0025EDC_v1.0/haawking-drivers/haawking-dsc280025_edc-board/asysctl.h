...
//
//*****************************************************************************
static inline void ASysCtl_setAnalogReference2P5(uint32_t reference)
{
	(void)reference;
...
//
//*****************************************************************************
static inline void ASysCtl_selectCMPHNMuxValue(uint32_t select, uint32_t value)
{
    ASSERT(select <= 0x7FU);
    ASSERT(value <= 1U);
...
//
//*****************************************************************************
static inline void ASysCtl_selectCMPLNMux(uint32_t select)
{
    ASSERT(select <= 0x7FU);
...
//
//*****************************************************************************
static inline void ASysCtl_selectCMPLNMuxValue(uint32_t select, uint32_t value)
{
    ASSERT(select <= 0x7FU);
    ASSERT(value <= 1U);
