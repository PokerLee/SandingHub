...
//
//*****************************************************************************
#define EPWM_SYNC_OUT_SOURCE_M    ((uint32_t)EPWM_SYNCOUTEN_SWEN             |\
                                   (uint32_t)EPWM_SYNCOUTEN_ZEROEN           |\
                                   (uint32_t)EPWM_SYNCOUTEN_CMPBEN           |\
                                   (uint32_t)EPWM_SYNCOUTEN_CMPCEN           |\
                                   (uint32_t)EPWM_SYNCOUTEN_CMPDEN           |\
                                   (uint32_t)EPWM_SYNCOUTEN_DCAEVT1EN        |\
                                   (uint32_t)EPWM_SYNCOUTEN_DCBEVT1EN)
...
typedef enum
{
    ...
    EPWM_COUNTER_COMPARE_B = 8, //!< counter compare B
    EPWM_COUNTER_COMPARE_C = 20, //!< counter compare C
    EPWM_COUNTER_COMPARE_D = 28  //!< counter compare D
...
typedef enum
{
    ...
    EPWM_AQ_OUTPUT_B =8  //!< ePWMxB output
...
typedef enum
{
    ...
    EPWM_DC_MODULE_B = 4  //!< Digital Compare Module B
...
//*****************************************************************************
#ifdef DEBUG
static __always_inline bool EPWM_isBaseValid(uint32_t base)
{
    return(
           (base == EPWM1_BASE) ||
           (base == EPWM2_BASE) ||
...
EPWM_setTimeBaseCounter(uint32_t base, uint32_t count)
{
    //
    // Check the arguments
    //
...
EPWM_setCountModeAfterSync(uint32_t base, EPWM_SyncCountMode mode)
{
    ...
    if(mode == EPWM_COUNT_MODE_UP_AFTER_SYNC)
    {
        ...
        // Set PHSDIR bit
        //
        HWREG(base + EPWM_O_TBCTL) |= EPWM_TBCTL_PHSDIR;
    }
    else
    {
        //
                       ...
                       EPWM_HSClockDivider highSpeedPrescaler)
{
    ...
    HWREG(base + EPWM_O_TBCTL) =
                ...
                (((uint32_t)prescaler << EPWM_TBCTL_CLKDIV_S) |
                ((uint32_t)highSpeedPrescaler << EPWM_TBCTL_HSPCLKDIV_S)));
}
...
EPWM_forceSyncPulse(uint32_t base)
{
    ...
    // Set SWFSYNC bit
    //
    HWREG(base + EPWM_O_TBCTL) |= EPWM_TBCTL_SWFSYNC;
}
...
EPWM_setSyncInPulseSource(uint32_t base, EPWM_SyncInPulseSource source)
{
    ...
    //
    HWREG(base + EPWM_O_SYNCINSEL) =
            (HWREG(base + EPWM_O_SYNCINSEL) & (~EPWM_SYNCINSEL_SEL_M)) |
            ((uint32_t)source & EPWM_SYNCINSEL_SEL_M);
}
...
//*****************************************************************************
static __always_inline void
EPWM_enableSyncOutPulseSource(uint32_t base, uint32_t source)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_SYNCOUTEN) = HWREG(base + EPWM_O_SYNCOUTEN) |
                                      (uint32_t)source;
}
...
//*****************************************************************************
static __always_inline void
EPWM_disableSyncOutPulseSource(uint32_t base, uint32_t source)
{
    //
    // Check the arguments
    //
                              ...
                              EPWM_OneShotSyncOutTrigger trigger)
{
    ...
    //
    HWREG(base + EPWM_O_TBCTL3) =
            (HWREG(base + EPWM_O_TBCTL3) & ~(EPWM_TBCTL3_OSSFRCEN)) |
            (uint32_t)trigger;
}
...
EPWM_setPeriodLoadMode(uint32_t base, EPWM_PeriodLoadMode loadMode)
{
    ...
    if(loadMode == EPWM_PERIOD_SHADOW_LOAD)
    {
        ...
        // Clear PRDLD
        //
        HWREG(base + EPWM_O_TBCTL) &= ~EPWM_TBCTL_PRDLD;
    }
    else
    {
        //
...
EPWM_enablePhaseShiftLoad(uint32_t base)
{
    ...
    // Set PHSEN bit
    //
    HWREG(base + EPWM_O_TBCTL) |= EPWM_TBCTL_PHSEN;
}
...
EPWM_setTimeBaseCounterMode(uint32_t base, EPWM_TimeBaseCountMode counterMode)
{
    ...
    //
    HWREG(base + EPWM_O_TBCTL) =
            ((HWREG(base + EPWM_O_TBCTL) & ~(EPWM_TBCTL_CTRMODE_M)) |
                           ...
                           EPWM_PeriodShadowLoadMode shadowLoadMode)
{
    ...
    //
    HWREG(base + EPWM_O_TBCTL2) =
                ((HWREG(base + EPWM_O_TBCTL2) & ~(EPWM_TBCTL2_PRDLDSYNC_M)) |
                 ((uint32_t)shadowLoadMode << EPWM_TBCTL2_PRDLDSYNC_S));
}
//*****************************************************************************
//
...
EPWM_enableOneShotSync(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_TBCTL2) |= EPWM_TBCTL2_OSHTSYNCMODE;
}
...
EPWM_startOneShotSync(uint32_t base)
{
    ...
    // Set OSHTSYNC bit
    //
    HWREG(base + EPWM_O_TBCTL2) |= EPWM_TBCTL2_OSHTSYNC;
}
...
EPWM_getTimeBaseCounterValue(uint32_t base)
{
    ...
    // Returns TBCTR value
    //
    return(HWREG(base + EPWM_O_TBCTR));
}
...
EPWM_getTimeBaseCounterOverflowStatus(uint32_t base)
{
    ...
    //
    return(((HWREG(base + EPWM_O_TBSTS) & EPWM_TBSTS_CTRMAX) ==
...
EPWM_clearTimeBaseCounterOverflowEvent(uint32_t base)
{
    ...
    // Set CTRMAX bit
    //
    HWREG(base + EPWM_O_TBSTS) = EPWM_TBSTS_CTRMAX;
}
...
EPWM_getSyncStatus(uint32_t base)
{
    ...
    //
    return(((HWREG(base + EPWM_O_TBSTS) & EPWM_TBSTS_SYNCI) ==
...
EPWM_clearSyncEvent(uint32_t base)
{
    ...
    // Set SYNCI bit
    //
    HWREG(base + EPWM_O_TBSTS) |= EPWM_TBSTS_SYNCI;
}
...
EPWM_getTimeBaseCounterDirection(uint32_t base)
{
    ...
    // Return CTRDIR bit
    //
    return(HWREG(base + EPWM_O_TBSTS) & EPWM_TBSTS_CTRDIR);
}
...
//*****************************************************************************
static __always_inline void
EPWM_setPhaseShift(uint32_t base, uint32_t phaseCount)
{
    //
    // Check the arguments
    //
...
//*****************************************************************************
static __always_inline void
EPWM_setTimeBasePeriod(uint32_t base, uint32_t periodCount)
{
    //
    // Check the arguments
    //
    ...
    // Write to TBPRD bit
    //
    HWREG(base + EPWM_O_TBPRD) = periodCount;
}
...
EPWM_getTimeBasePeriod(uint32_t base)
{
    ...
    // Read from TBPRD bit
    //
    return(HWREG(base + EPWM_O_TBPRD));
}
                            ...
                            uint32_t compCount)
{
        ...
        (compModule == EPWM_COUNTER_COMPARE_B))
    {
        ...
        //
    	HWREG(base + registerOffset ) = (((HWREG(base + registerOffset ))&0x0000FFFF)|(uint32_t)(compCount<<16));
    }
    else
    {
        //
        ...
        //
    	HWREG(base + registerOffset) = compCount;
    }
}
...
EPWM_getCounterCompareValue(uint32_t base, EPWM_CounterCompareModule compModule)
{
        ...
        (compModule == EPWM_COUNTER_COMPARE_B))
    {
        ...
        //
        compCount = (uint32_t)((HWREG(base + registerOffset) &
    ...
    else
    {
        ...
        //
        compCount = HWREG(base + registerOffset);
    }
    return(compCount);
}
                                   ...
                                   EPWM_CounterCompareModule compModule)
{
    ...
    return((((HWREG(base + EPWM_O_CMPCTL) >>
              ((((uint32_t)compModule >> 3U) & 0x1U) + 8U)) &
                                      ...
                                      EPWM_ActionQualifierLoadMode loadMode)
{
    ...
    syncModeOffset = 8U + (uint32_t)aqModule;
    shadowModeOffset = 4U + (uint32_t)aqModule;

    //
    // Set the appropriate sync and load mode bits and also enable shadow
    // load mode. Shadow to active load can also be frozen.
    //
    HWREG(base + EPWM_O_AQCTL) = (((HWREG(base + EPWM_O_AQCTL) &
                                       (~((0x3U << (uint32_t)aqModule) |
                                       (0x3U << (uint32_t)syncModeOffset)))) |
                                       (0x1U << shadowModeOffset)) |
                                       ((((uint32_t)loadMode >> 2U) <<
                                         syncModeOffset) | (((uint32_t)loadMode &
                                        0x3U) << (uint32_t)aqModule)));
}
                                          ...
                                          EPWM_ActionQualifierModule aqModule)
{
    ...
    // immediate mode only.
    //
    HWREG(base + EPWM_O_AQCTL) &= ~(1U << shadowModeOffset);
}
                                     ...
                                     EPWM_ActionQualifierTriggerSource trigger)
{
    ...
    //
    HWREG(base + EPWM_O_AQTSRCSEL) =
         ((HWREG(base + EPWM_O_AQTSRCSEL) & (~EPWM_AQTSRCSEL_T1SEL_M)) |
          ((uint32_t)trigger));
}
                                      ...
                                      EPWM_ActionQualifierTriggerSource trigger)
{
    ...
    //
    HWREG(base + EPWM_O_AQTSRCSEL) =
          ((HWREG(base + EPWM_O_AQTSRCSEL) & (~EPWM_AQTSRCSEL_T2SEL_M)) |
           ((uint32_t)trigger << EPWM_AQTSRCSEL_T2SEL_S));
}
                              ...
                              EPWM_ActionQualifierOutputEvent event)
{
    ...
    //
    if(((uint32_t)event & 0x1U) == 1U)
    {
        //
        // Write to T1U,T1D,T2U or T2D of AQCTLA2 register
        //
    	HWREG(base + registerTOffset) =
         ((HWREG(base + registerTOffset) & ~(3U << ((uint32_t)event - 1U))) |
          ((uint32_t)output << ((uint32_t)event - 1U)));
    }
    else
    {
        //
        ...
        //
    	HWREG(base + registerOffset) =
                ((HWREG(base + registerOffset) & ~(3U << (uint32_t)event)) |
                                   ...
                                   uint32_t action)
{
    ...
    // Write to ZRO, PRD, CAU, CAD, CBU or CBD bits of AQCTLA register
    //
    HWREG(base + registerOffset) = (uint32_t)action;
}
                               ...
                               uint32_t action)
{
    ...
    // Get the register offset
    //
    registerTOffset = (uint32_t)(EPWM_O_AQCTLA2 + (uint32_t)epwmOutput);

    //
    // Write to T1U, T1D, T2U or T2D of AQCTLA2 register
    //
    HWREG(base + registerTOffset) = (uint32_t)action;
}
                                             ...
                                             EPWM_ActionQualifierContForce mode)
{
    ...
    // Write to RLDCSF bit
    //
    HWREG(base + EPWM_O_AQSFRC) =
            ((HWREG(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_RLDCSF_M) |
             ((uint32_t)mode << EPWM_AQSFRC_RLDCSF_S));
}
                                    ...
                                    EPWM_ActionQualifierSWOutput output)
{
    ...
    {
    	HWREG(base + EPWM_O_AQCSFRC) =
                ((HWREG(base + EPWM_O_AQCSFRC) & ~EPWM_AQCSFRC_CSFA_M) |
                 ((uint32_t)output));
    }
    else
    {
    	HWREG(base + EPWM_O_AQCSFRC) =
                ((HWREG(base + EPWM_O_AQCSFRC) & ~EPWM_AQCSFRC_CSFB_M) |
                 ((uint32_t)output << EPWM_AQCSFRC_CSFB_S)) ;
    }
}
                                ...
                                EPWM_ActionQualifierOutput output)
{
    ...
    {
    	HWREG(base + EPWM_O_AQSFRC) =
                    ((HWREG(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_ACTSFA_M) |
                     ((uint32_t)output));
    }
    else
    {
    	HWREG(base + EPWM_O_AQSFRC) =
                    ((HWREG(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_ACTSFB_M) |
                     ((uint32_t)output << EPWM_AQSFRC_ACTSFB_S));
    }
}
                                  ...
                                  EPWM_ActionQualifierOutputModule epwmOutput)
{
    ...
    if(epwmOutput == EPWM_AQ_OUTPUT_A)
    {
    	HWREG(base + EPWM_O_AQSFRC) |= EPWM_AQSFRC_OTSFA;
    }
    else
    {
    	HWREG(base + EPWM_O_AQSFRC) |= EPWM_AQSFRC_OTSFB;
    }
}
                               ...
                               bool enableSwapMode)
{
    ...
    mask = (uint32_t)1U << ((uint32_t)output + EPWM_DBCTL_OUTSWAP_S);
    ...
    if(enableSwapMode)
    {
        ...
        //
    	HWREG(base + EPWM_O_DBCTL) = (HWREG(base + EPWM_O_DBCTL) | mask);
    }
    else
    {
        //
                          ...
                          bool enableDelayMode)
{
    ...
    mask = (uint32_t)1U << ((uint32_t)(delayMode + EPWM_DBCTL_OUT_MODE_S));
                              ...
                              EPWM_DeadBandPolarity polarity)
{
    ...
    shift = (((uint32_t)delayMode ^ 0x1U) + EPWM_DBCTL_POLSEL_S);

    //
    // Set the appropriate polsel bits for dead band polarity
    //
    HWREG(base + EPWM_O_DBCTL) =
                       ((HWREG(base + EPWM_O_DBCTL) & ~ (1U << shift)) |
...
//*****************************************************************************
static __always_inline void
EPWM_setRisingEdgeDeadBandDelayInput(uint32_t base, uint32_t input)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_DBCTL) =
            ((HWREG(base + EPWM_O_DBCTL) & ~(1U << (EPWM_DBCTL_IN_MODE_S))) |
...
//*****************************************************************************
static __always_inline void
EPWM_setFallingEdgeDeadBandDelayInput(uint32_t base, uint32_t input)
{
    //
    // Check the arguments
    //
    ...
    if(input == EPWM_DB_INPUT_DB_RED)
    {
        ...
        //
    	HWREG(base + EPWM_O_DBCTL) |= EPWM_DBCTL_DEDB_MODE;
    }
    else
    {
        //
        ...
        //
    	HWREG(base + EPWM_O_DBCTL) =
        ((HWREG(base + EPWM_O_DBCTL) & ~(1U << (EPWM_DBCTL_IN_MODE_S + 1U))) |
                                      ...
                                      EPWM_DeadBandControlLoadMode loadMode)
{
    ...
    //
    HWREG(base + EPWM_O_DBCTL2) =
          ((HWREG(base + EPWM_O_DBCTL2) & ~EPWM_DBCTL2_LOADDBCTLMODE_M) |
           (EPWM_DBCTL2_SHDWDBCTLMODE | (uint32_t)loadMode));
}
...
EPWM_disableDeadBandControlShadowLoadMode(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_DBCTL2) =
                 (HWREG(base + EPWM_O_DBCTL2) & ~EPWM_DBCTL2_SHDWDBCTLMODE);
}
                                         ...
                                         EPWM_RisingEdgeDelayLoadMode loadMode)
{
    ...
    //
    HWREG(base + EPWM_O_DBCTL) =
               ((HWREG(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_LOADREDMODE_M) |
                ((uint32_t)EPWM_DBCTL_SHDWDBREDMODE |
                ((uint32_t)loadMode << EPWM_DBCTL_LOADREDMODE_S)));
...
EPWM_disableRisingEdgeDelayCountShadowLoadMode(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_DBCTL) =
                   (HWREG(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_SHDWDBREDMODE);
                                        ...
                                        EPWM_FallingEdgeDelayLoadMode loadMode)
{
    ...
    //
    HWREG(base + EPWM_O_DBCTL) =
            ((HWREG(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_LOADFEDMODE_M) |
                (EPWM_DBCTL_SHDWDBFEDMODE |
                ((uint32_t)loadMode << EPWM_DBCTL_LOADFEDMODE_S)));
...
EPWM_disableFallingEdgeDelayCountShadowLoadMode(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_DBCTL) =
              (HWREG(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_SHDWDBFEDMODE);
}
                             ...
                             EPWM_DeadBandClockMode clockMode)
{
    ...
    //
    HWREG(base + EPWM_O_DBCTL) =
                ((HWREG(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_HALFCYCLE) |
                 ((uint32_t)clockMode << 15U));
}
...
//*****************************************************************************
static __always_inline void
EPWM_setRisingEdgeDelayCount(uint32_t base, uint32_t redCount)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_DBRED) = redCount;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setFallingEdgeDelayCount(uint32_t base, uint32_t fedCount)
{
    //
    // Check the arguments
    //
    ...
    // Set the RED (Rising Edge Delay) count
    //
    HWREG(base + EPWM_O_DBFED) = fedCount;
}
...
EPWM_enableChopper(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_PCCTL) |= EPWM_PCCTL_CHPEN;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setChopperDutyCycle(uint32_t base, uint32_t dutyCycleCount)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_PCCTL) =
               ((HWREG(base + EPWM_O_PCCTL) & ~EPWM_PCCTL_CHPDUTY_M) |
...
//*****************************************************************************
static __always_inline void
EPWM_setChopperFreq(uint32_t base, uint32_t freqDiv)
{
    //
    // Check the arguments
    //
...
//*****************************************************************************
static __always_inline void
EPWM_setChopperFirstPulseWidth(uint32_t base, uint32_t firstPulseWidth)
{
    //
    // Check the arguments
    //
...
EPWM_enableTripZoneSignals(uint32_t base, uint32_t tzSignal)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZSEL) |= tzSignal;
    EDIS;
}
                                 ...
                                 EPWM_TripZoneDigitalCompareOutputEvent dcEvent)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZDCSEL) =
           ((HWREG(base + EPWM_O_TZDCSEL) & ~(0x7U << (uint32_t)dcType)) |
            ((uint32_t)dcEvent << (uint32_t)dcType));
    EDIS;
}
...
EPWM_enableTripZoneAdvAction(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCTL2) |= EPWM_TZCTL2_ETZE;
    EDIS;
}
                       ...
                       EPWM_TripZoneAction tzAction)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCTL) =
         ((HWREG(base + EPWM_O_TZCTL) & ~(0x3U << (uint32_t)tzEvent)) |
          ((uint32_t)tzAction << (uint32_t)tzEvent)) ;
    EDIS;
}
                          ...
                          EPWM_TripZoneAdvancedAction tzAdvAction)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCTL2) =
       ((HWREG(base + EPWM_O_TZCTL2) & ~(0x7U << (uint32_t)tzAdvEvent)) |
        ((uint32_t)tzAdvAction << (uint32_t)tzAdvEvent));
                              ...
                              EPWM_TripZoneAdvancedAction tzAdvDCAction)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCTLDCA) =
      ((HWREG(base + EPWM_O_TZCTLDCA) & ~(0x7U << (uint32_t)tzAdvDCEvent)) |
       ((uint32_t)tzAdvDCAction << (uint32_t)tzAdvDCEvent));
...
//
//*****************************************************************************
static __always_inline void EPWM_setTripZoneAdvDigitalCompareActionB(uint32_t base,
                              EPWM_TripZoneAdvDigitalCompareEvent tzAdvDCEvent,
                              EPWM_TripZoneAdvancedAction tzAdvDCAction)
{
    //
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCTLDCB) =
     ((HWREG(base + EPWM_O_TZCTLDCB) & ~(0x7U << (uint32_t)tzAdvDCEvent)) |
      ((uint32_t)tzAdvDCAction << (uint32_t)tzAdvDCEvent));
...
//*****************************************************************************
static __always_inline void
EPWM_enableTripZoneInterrupt(uint32_t base, uint32_t tzInterrupt)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZEINT) |= tzInterrupt;
    EDIS;
}
...
//***************************************************************************
static __always_inline void
EPWM_disableTripZoneInterrupt(uint32_t base, uint32_t tzInterrupt)
{
    //
    // Check the arguments
    //
...
EPWM_getTripZoneFlagStatus(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_TZFLG) & 0x7FU);
}
...
EPWM_getCycleByCycleTripZoneFlagStatus(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_TZCBCFLG) & 0xFFU);
}
...
EPWM_getOneShotTripZoneFlagStatus(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_TZOSTFLG) & 0xFFU);
}
                                 ...
                                 EPWM_CycleByCycleTripZoneClearMode clearEvent)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCLR) =
                 ((HWREG(base + EPWM_O_TZCLR) & ~EPWM_TZCLR_CBCPULSE_M) |
                  ((uint32_t)clearEvent << EPWM_TZCLR_CBCPULSE_S));
    EDIS;
}
...
//***************************************************************************
static __always_inline void
EPWM_clearTripZoneFlag(uint32_t base, uint32_t tzFlags)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCLR) |= tzFlags;
    EDIS;
}
...
//***************************************************************************
static __always_inline void
EPWM_clearCycleByCycleTripZoneFlag(uint32_t base, uint32_t tzCBCFlags)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZCBCCLR) |= tzCBCFlags;
    EDIS;
}
...
//***************************************************************************
static __always_inline void
EPWM_clearOneShotTripZoneFlag(uint32_t base, uint32_t tzOSTFlags)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZOSTCLR) |= tzOSTFlags;
    EDIS;
}
...
//***************************************************************************
static __always_inline void
EPWM_forceTripZoneEvent(uint32_t base, uint32_t tzForceEvent)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_TZFRC) |= tzForceEvent;
    EDIS;
}
...
EPWM_enableInterrupt(uint32_t base)
{
    ...
    // Enable ePWM interrupt
    //
    HWREG(base + EPWM_O_ETSEL) |= EPWM_ETSEL_INTEN;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setInterruptSource(uint32_t base, uint32_t interruptSource)
{
    uint32_t intSource;
       ...
       (interruptSource == EPWM_INT_TBCTR_D_CMPD))
    {
          ...
          //
          HWREG(base + EPWM_O_ETSEL) |= EPWM_ETSEL_INTSELCMP;
    }
    ...
    //
    HWREG(base + EPWM_O_ETSEL) =
            ((HWREG(base + EPWM_O_ETSEL) & ~EPWM_ETSEL_INTSEL_M) | intSource);
}
...
//*****************************************************************************
static __always_inline void
EPWM_setInterruptEventCount(uint32_t base, uint32_t eventCount)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_ETPS) |= EPWM_ETPS_INTPSSEL;
    HWREG(base + EPWM_O_ETINTPS) =
         ((HWREG(base + EPWM_O_ETINTPS) & ~EPWM_ETINTPS_INTPRD2_M) |
           eventCount);
}
...
EPWM_getEventTriggerInterruptStatus(uint32_t base)
{
    ...
    //
    return(((HWREG(base + EPWM_O_ETFLG) & 0x1U) == 0x1U) ? true : false);
}
...
EPWM_clearEventTriggerInterruptFlag(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_ETCLR) |= EPWM_ETCLR_INT;
}
...
EPWM_enableInterruptEventCountInit(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_ETCNTINITCTL) |= EPWM_ETCNTINITCTL_INTINITEN;
}
...
EPWM_forceInterruptEventCountInit(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_ETCNTINITCTL) |= EPWM_ETCNTINITCTL_INTINITFRC;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setInterruptEventCountInitValue(uint32_t base, uint32_t eventCount)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_ETCNTINIT) =
         ((HWREG(base + EPWM_O_ETCNTINIT) & ~EPWM_ETCNTINIT_INTINIT_M) |
          (uint32_t)(eventCount & 0xFU));
}
...
EPWM_getInterruptEventCount(uint32_t base)
{
    ...
    //
    return(((HWREG(base + EPWM_O_ETINTPS) & EPWM_ETINTPS_INTCNT2_M) >>
...
EPWM_forceEventTriggerInterrupt(uint32_t base)
{
    ...
    //
    HWREG(base + EPWM_O_ETFRC) |= EPWM_ETFRC_INT;
}
...
EPWM_enableADCTrigger(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    {
         HWREG(base + EPWM_O_ETSEL) |= EPWM_ETSEL_SOCAEN;
    }
    else
    {
         HWREG(base + EPWM_O_ETSEL) |= EPWM_ETSEL_SOCBEN;
    }
}
                         ...
                         EPWM_ADCStartOfConversionSource socSource)
{
    ...
    if(adcSOCType == EPWM_SOC_A)
    {
        ...
        //
        HWREG(base + EPWM_O_ETSEL) =
                ((HWREG(base + EPWM_O_ETSEL) & ~EPWM_ETSEL_SOCASEL_M) |
           ...
           (socSource == EPWM_SOC_TBCTR_D_CMPB))
        {
            ...
            // Enable events based on comp A or comp B
            //
            HWREG(base + EPWM_O_ETSEL) &= ~EPWM_ETSEL_SOCASELCMP;
        }
    ...
    else
    {
        ...
        //
        HWREG(base + EPWM_O_ETSEL) =
                ((HWREG(base + EPWM_O_ETSEL) & ~EPWM_ETSEL_SOCBSEL_M) |
           ...
           (socSource == EPWM_SOC_TBCTR_D_CMPB))
        {
            ...
            // Enable events based on comp A or comp B
            //
            HWREG(base + EPWM_O_ETSEL) &= ~EPWM_ETSEL_SOCBSELCMP;
        }
        else if((socSource == EPWM_SOC_TBCTR_U_CMPC) ||
                (socSource == EPWM_SOC_TBCTR_U_CMPD) ||
                (socSource == EPWM_SOC_TBCTR_D_CMPC) ||
                                ...
                                uint32_t preScaleCount)
{
    ...
    //
    HWREG(base + EPWM_O_ETPS) |= EPWM_ETPS_SOCPSSEL;
    if(adcSOCType == EPWM_SOC_A)
    {
        //
        // Set the count for SOC A
        //
        HWREG(base + EPWM_O_ETSOCPS) =
           ((HWREG(base + EPWM_O_ETSOCPS) & ~EPWM_ETSOCPS_SOCAPRD2_M) |
             preScaleCount);
    }
    else
    {
        ...
        //
        HWREG(base + EPWM_O_ETSOCPS) =
             ((HWREG(base + EPWM_O_ETSOCPS) & ~EPWM_ETSOCPS_SOCBPRD2_M) |
                             ...
                             EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    //
    return((((HWREG(base + EPWM_O_ETFLG) >>
              ((uint32_t)adcSOCType + 2U)) & 0x1U) == 0x1U) ? true : false);
}
                         ...
                         EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    //
    HWREG(base + EPWM_O_ETCLR) |= 1U << ((uint32_t)adcSOCType + 2U);
}
                                    ...
                                    EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    //
    HWREG(base + EPWM_O_ETCNTINITCTL) |= 1U << ((uint32_t)adcSOCType + 14U);
}
                                     ...
                                     EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    //
    HWREG(base + EPWM_O_ETCNTINITCTL) &=
                                  ~(1U << ((uint32_t)adcSOCType + 14U));
}
                                   ...
                                   EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    // Load the Interrupt Event counter value
    //
    HWREG(base + EPWM_O_ETCNTINITCTL) |= 1U << ((uint32_t)adcSOCType + 11U);
}
                                      ...
                                      uint32_t eventCount)
{
    ...
    {
        HWREG(base + EPWM_O_ETCNTINIT) =
            ((HWREG(base + EPWM_O_ETCNTINIT) & ~EPWM_ETCNTINIT_SOCAINIT_M) |
             (uint32_t)(eventCount << EPWM_ETCNTINIT_SOCAINIT_S));
    }
    else
    {
        HWREG(base + EPWM_O_ETCNTINIT) =
             ((HWREG(base + EPWM_O_ETCNTINIT) & ~EPWM_ETCNTINIT_SOCBINIT_M) |
                             ...
                             EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    if(adcSOCType == EPWM_SOC_A)
    {
        eventCount = (HWREG(base + EPWM_O_ETSOCPS) >>
...
EPWM_forceADCTrigger(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    ...
    //
    HWREG(base + EPWM_O_ETFRC) |= 1U << ((uint32_t)adcSOCType + 2U);
}
                                   ...
                                   EPWM_DigitalCompareType dcType)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCTRIPSEL) =
     ((HWREG(base + EPWM_O_DCTRIPSEL) & ~(0xFU << ((uint32_t)dcType << 2U))) |
      ((uint32_t)tripSource << ((uint32_t)dcType << 2U)));
    EDIS;
}
...
EPWM_enableDigitalCompareBlankingWindow(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCFCTL) |= EPWM_DCFCTL_BLANKE;
    EDIS;
}
...
EPWM_enableDigitalCompareWindowInverseMode(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCFCTL) |= EPWM_DCFCTL_BLANKINV;
    EDIS;
}
                                ...
                                EPWM_DigitalCompareBlankingPulse blankingPulse)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCFCTL) =
            ((HWREG(base + EPWM_O_DCFCTL) & ~EPWM_DCFCTL_PULSESEL_M) |
             ((uint32_t)((uint32_t)blankingPulse << EPWM_DCFCTL_PULSESEL_S)));
    EDIS;
}
                                  ...
                                  EPWM_DigitalCompareFilterInput filterInput)
{
    ...
    EALLOW;
    HWREG(base + EPWM_O_DCFCTL) =
                  ((HWREG(base + EPWM_O_DCFCTL) & ~EPWM_DCFCTL_SRCSEL_M) |
                   ((uint32_t)filterInput));
    EDIS;
}
...
EPWM_enableDigitalCompareEdgeFilter(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCFCTL) |= EPWM_DCFCTL_EDGEFILTSEL;
    EDIS;
}
                                     ...
                                     EPWM_DigitalCompareEdgeFilterMode edgeMode)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCFCTL) = (HWREG(base + EPWM_O_DCFCTL) &
                                    ~EPWM_DCFCTL_EDGEMODE_M) |
                                   ((uint32_t)edgeMode << EPWM_DCFCTL_EDGEMODE_S);
    EDIS;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setDigitalCompareEdgeFilterEdgeCount(uint32_t base, uint32_t edgeCount)
{
    //
    // Check the arguments
    //
...
EPWM_getDigitalCompareEdgeFilterEdgeCount(uint32_t base)
{
    ...
    //
    return((HWREG(base + EPWM_O_DCFCTL) & EPWM_DCFCTL_EDGECOUNT_M) >>
...
EPWM_getDigitalCompareEdgeFilterEdgeStatus(uint32_t base)
{
    ...
    //
    return((HWREG(base + EPWM_O_DCFCTL) & EPWM_DCFCTL_EDGESTATUS_M) >>
...
//*****************************************************************************
static __always_inline void
EPWM_setDigitalCompareWindowOffset(uint32_t base, uint32_t windowOffsetCount)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_DCFOFFSET) = windowOffsetCount;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setDigitalCompareWindowLength(uint32_t base, uint32_t windowLengthCount)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_DCFWINDOW) = windowLengthCount;
}
...
EPWM_getDigitalCompareBlankingWindowOffsetCount(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_DCFOFFSETCNT));
}
...
EPWM_getDigitalCompareBlankingWindowLengthCount(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_DCFWINDOWCNT));
}
                                  ...
                                  EPWM_DigitalCompareEventSource dcEventSource)
{
    ...
    {
        HWREG(base + registerOffset) =
                ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT1SRCSEL) |
                 (uint32_t)dcEventSource);
    }
    else
    {
        HWREG(base + registerOffset) =
                 ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT2SRCSEL) |
                  ((uint32_t)dcEventSource << 8U));
    }
    EDIS;
}
                                    ...
                                    EPWM_DigitalCompareSyncMode syncMode)
{
    ...
    {
        HWREG(base + registerOffset) =
           ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT1FRCSYNCSEL) |
            ((uint32_t)syncMode << 1U));
    }
    else
    {
        HWREG(base + registerOffset) =
            ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT2FRCSYNCSEL) |
             ((uint32_t)syncMode << 9U));
    }
    EDIS;
}
                                    ...
                                    EPWM_DigitalCompareModule dcModule)
{
    ...
    EALLOW;
    HWREG(base + registerOffset) =
                       (HWREG(base + registerOffset) | EPWM_DCACTL_EVT1SOCE);
    EDIS;
}
                                   ...
                                   EPWM_DigitalCompareModule dcModule)
{
    ...
    EALLOW;
    HWREG(base + registerOffset) =
                     (HWREG(base + registerOffset) | EPWM_DCACTL_EVT1SYNCE);
    EDIS;
}
                                   ...
                                   EPWM_DigitalCompareCBCLatchMode latchMode)
{
    ...
    {
        HWREG(base + registerOffset) =
           ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT1LATSEL) |
            ((uint32_t)latchMode << 4U));
    }
    else
    {
        HWREG(base + registerOffset) =
            ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT2LATSEL) |
             ((uint32_t)latchMode << 12U));
    }
    EDIS;
}
                              ...
                              EPWM_DigitalCompareCBCLatchClearEvent clearEvent)
{
    ...
    {
        HWREG(base + registerOffset) =
           ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT1LATCLRSEL_M) |
            ((uint32_t)clearEvent << EPWM_DCACTL_EVT1LATCLRSEL_S));
    }
    else
    {
        HWREG(base + registerOffset) =
            ((HWREG(base + registerOffset) & ~EPWM_DCACTL_EVT2LATCLRSEL_M) |
                                     ...
                                     EPWM_DigitalCompareEvent dcEvent)
{
    ...
    if(dcEvent == EPWM_DC_EVENT_1)
    {
        status = HWREG(base + registerOffset) & EPWM_DCACTL_EVT1LAT;
    }
    else
    {
        status = HWREG(base + registerOffset) & EPWM_DCACTL_EVT2LAT;
    }
    return(status != 0U);
}
...
EPWM_enableDigitalCompareCounterCapture(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCCAPCTL) |= EPWM_DCCAPCTL_CAPE;
    EDIS;
}
...
EPWM_setDigitalCompareCounterShadowMode(uint32_t base, bool enableShadowMode)
{
    ...
    if(enableShadowMode)
    {
        ...
        //
        HWREG(base + EPWM_O_DCCAPCTL) &= ~EPWM_DCCAPCTL_SHDWMODE;
    }
    else
    {
       //
...
EPWM_getDigitalCompareCaptureStatus(uint32_t base)
{
    ...
    //
    return((HWREG(base + EPWM_O_DCCAPCTL) & EPWM_DCCAPCTL_CAPSTS) ==
...
EPWM_clearDigitalCompareCaptureStatusFlag(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_DCCAPCTL) &= ~EPWM_DCCAPCTL_CAPCLR;
    EDIS;
}
                                               ...
                                               bool disableClearMode)
{
    ...
    if(disableClearMode)
    {
        ...
        //
        HWREG(base + EPWM_O_DCCAPCTL) |= EPWM_DCCAPCTL_CAPMODE;
    }
    else
    {
       //
...
EPWM_getDigitalCompareCaptureCount(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_DCCAP));
}
                                              ...
                                              EPWM_DigitalCompareType dcType)
{
    ...
    //
    registerOffset = EPWM_O_DCAHTRIPSEL + (uint32_t)(dcType * 4);
    ...
    EALLOW;
    HWREG(base + registerOffset) =
                           (HWREG(base + registerOffset) | tripInput);
...
EPWM_enableValleyCapture(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_VCAPCTL) |= EPWM_VCAPCTL_VCAPE;
    EDIS;
}
...
EPWM_startValleyCapture(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_VCAPCTL) |= EPWM_VCAPCTL_VCAPSTART;
    EDIS;
}
...
EPWM_setValleyTriggerSource(uint32_t base, EPWM_ValleyTriggerSource trigger)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_VCAPCTL) =
             ((HWREG(base + EPWM_O_VCAPCTL) & ~EPWM_VCAPCTL_TRIGSEL_M) |
              ((uint32_t)trigger << 2U));
    EDIS;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setValleyTriggerEdgeCounts(uint32_t base, uint32_t startCount,
                                uint32_t stopCount)
{
    //
    // Check the arguments
...
EPWM_enableValleyHWDelay(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_VCAPCTL) |= EPWM_VCAPCTL_EDGEFILTDLYSEL;
    EDIS;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setValleySWDelayValue(uint32_t base, uint32_t delayOffsetValue)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_SWVDELVAL) = delayOffsetValue;
}
...
EPWM_setValleyDelayDivider(uint32_t base, EPWM_ValleyDelayMode delayMode)
{
    ...
    EALLOW;
    HWREG(base + EPWM_O_VCAPCTL) =
         ((HWREG(base + EPWM_O_VCAPCTL) & ~EPWM_VCAPCTL_VDELAYDIV_M) |
          ((uint32_t)delayMode << 7U));
    EDIS;
}
...
EPWM_getValleyEdgeStatus(uint32_t base, EPWM_ValleyCounterEdge edge)
{
    ...
    if(edge == EPWM_VALLEY_COUNT_START_EDGE)
    {
        ...
        //
        return(((HWREG(base + EPWM_O_VCNTCFG) & EPWM_VCNTCFG_STARTEDGESTS) ==
    ...
    else
    {
        ...
        //
        return(((HWREG(base + EPWM_O_VCNTCFG) & EPWM_VCNTCFG_STOPEDGESTS) ==
...
EPWM_getValleyCount(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_VCNTVAL));
}
...
EPWM_getValleyHWDelay(uint32_t base)
{
    ...
    //
    return(HWREG(base + EPWM_O_HWVDELVAL));
}
...
EPWM_enableGlobalLoad(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_GLDCTL) |= EPWM_GLDCTL_GLD;
    EDIS;
}
...
EPWM_setGlobalLoadTrigger(uint32_t base, EPWM_GlobalLoadTrigger loadTrigger)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_GLDCTL) =
               ((HWREG(base + EPWM_O_GLDCTL) & ~EPWM_GLDCTL_GLDMODE_M) |
                ((uint32_t)loadTrigger << EPWM_GLDCTL_GLDMODE_S));
    EDIS;
}
...
//*****************************************************************************
static __always_inline void
EPWM_setGlobalLoadEventPrescale(uint32_t base, uint32_t prescalePulseCount)
{
    //
    // Check the arguments
    //
    ...
    EALLOW;
    HWREG(base + EPWM_O_GLDCTL) =
                ((HWREG(base + EPWM_O_GLDCTL) & ~EPWM_GLDCTL_GLDPRD_M) |
...
EPWM_getGlobalLoadEventCount(uint32_t base)
{
    ...
    //
    return((HWREG(base + EPWM_O_GLDCTL) >> EPWM_GLDCTL_GLDCNT_S) & 0x7U);
}
...
EPWM_disableGlobalLoadOneShotMode(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_GLDCTL) &= ~EPWM_GLDCTL_OSHTMODE;
    EDIS;
}
...
EPWM_setGlobalLoadOneShotLatch(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_GLDCTL2) |= EPWM_GLDCTL2_OSHTLD;
    EDIS;
}
...
EPWM_forceGlobalLoadOneShotEvent(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_GLDCTL2) |= EPWM_GLDCTL2_GFRCLD;
    EDIS;
}
...
//*****************************************************************************
static __always_inline void
EPWM_enableGlobalLoadRegisters(uint32_t base, uint32_t loadRegister)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREG(base + EPWM_O_GLDCFG) |= loadRegister;
    EDIS;
}
...
//*****************************************************************************
static __always_inline void
EPWM_disableGlobalLoadRegisters(uint32_t base, uint32_t loadRegister)
{
    //
    // Check the arguments
    //
