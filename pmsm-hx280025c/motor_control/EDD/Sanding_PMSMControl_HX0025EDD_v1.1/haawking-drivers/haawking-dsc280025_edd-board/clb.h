...
typedef enum
{
    ...
    CLB_LOCAL_IN_MUX_LIN_TX             = 23,  //!< LIN A/B TX
    ...
    CLB_LOCAL_IN_MUX_EPWM3_DCAEVT1      = 32,  //!< EPWM3 DCAEVT1 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCAEVT1      = 32,  //!< EPWM4 DCAEVT1 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_DCAEVT2      = 33,  //!< EPWM3 DCAEVT2 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCAEVT2      = 33,  //!< EPWM4 DCBEVT2 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_DCBEVT1      = 34,  //!< EPWM3 DCBEVT1 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCBEVT1      = 34,  //!< EPWM4 DCBEVT1 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_DCBEVT2      = 35,  //!< EPWM3 DCBEVT2 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCBEVT2      = 35,  //!< EPWM4 DCBEVT2 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_DCAH         = 36,  //!< EPWM3 DCAH (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCAH         = 36,  //!< EPWM4 DCAH (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_DCAL         = 37,  //!< EPWM3 DCAL (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCAL         = 37,  //!< EPWM4 DCAL (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_DCBH         = 38,  //!< EPWM3 DCBH (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCBH         = 38,  //!< EPWM4 DCBH (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_DCBL         = 39,  //!< EPWM3 DCBL (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_DCBL         = 39,  //!< EPWM4 DCBL (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_OST          = 40,  //!< EPWM3 OST (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_OST          = 40,  //!< EPWM4 OST (CLB2)
    CLB_LOCAL_IN_MUX_EPWM3_CBC          = 41,  //!< EPWM3 CBC (CLB1)
    CLB_LOCAL_IN_MUX_EPWM4_CBC          = 41,  //!< EPWM4 CBC (CLB2)
    CLB_LOCAL_IN_MUX_EPWM5_DCAEVT1      = 42,  //!< EPWM5 DCAEVT1 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM6_DCAEVT1      = 42,  //!< EPWM6 DCAEVT1 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM5_DCAEVT2      = 43,  //!< EPWM5 DCAEVT2 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM6_DCAEVT2      = 43,  //!< EPWM6 DCBEVT2 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM5_DCBEVT1      = 44,  //!< EPWM5 DCBEVT1 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM6_DCBEVT1      = 44,  //!< EPWM6 DCBEVT1 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM5_DCBEVT2      = 45,  //!< EPWM5 DCBEVT2 (CLB1)
    CLB_LOCAL_IN_MUX_EPWM6_DCBEVT2      = 45,  //!< EPWM6 DCBEVT2 (CLB2)
    CLB_LOCAL_IN_MUX_EPWM5_DCAH         = 46,  //!< EPWM5 DCAH (CLB1)
    CLB_LOCAL_IN_MUX_EPWM6_DCAH         = 46,  //!< EPWM6 DCAH (CLB2)
    CLB_LOCAL_IN_MUX_EPWM5_DCAL         = 47,  //!< EPWM5 DCAL (CLB1)
    CLB_LOCAL_IN_MUX_EPWM6_DCAL         = 47,  //!< EPWM6 DCAL (CLB2)
...
typedef enum
{
    ...
    CLB_GLOBAL_IN_MUX_EPWM2A            = 16,  //!< EPWM2A (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6A            = 16,  //!< EPWM6A (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2A_OE         = 17,  //!< EPWM2A trip output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6A_OE         = 17,  //!< EPWM6A trip output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2B            = 18,  //!< EPWM2B (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6B            = 18,  //!< EPWM6B (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2B_OE         = 19,  //!< EPWM2B trip output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6B_OE         = 19,  //!< EPWM6B trip output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_CTR_ZERO    = 20,  //!< EPWM2 TBCTR = Zero (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_CTR_ZERO    = 20,  //!< EPWM6 TBCTR = Zero (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_CTR_PRD     = 21,  //!< EPWM2 TBCTR = TBPRD (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_CTR_PRD     = 21,  //!< EPWM6 TBCTR = TBPRD (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_CTRDIR      = 22,  //!< EPWM2 CTRDIR (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_CTRDIR      = 22,  //!< EPWM6 CTRDIR (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_TBCLK       = 23,  //!< EPWM2 TBCLK (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_TBCLK       = 23,  //!< EPWM6 TBCLK (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_CTR_CMPA    = 24,  //!< EPWM2 TBCTR = CMPA (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_CTR_CMPA    = 24,  //!< EPWM6 TBCTR = CMPA (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_CTR_CMPB    = 25,  //!< EPWM2 TBCTR = CMPB (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_CTR_CMPB    = 25,  //!< EPWM6 TBCTR = CMPB (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_CTR_CMPC    = 26,  //!< EPWM2 TBCTR = CMPC (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_CTR_CMPC    = 26,  //!< EPWM6 TBCTR = CMPC (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2_CTR_CMPD    = 27,  //!< EPWM2 TBCTR = CMPD (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_CTR_CMPD    = 27,  //!< EPWM6 TBCTR = CMPD (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2A_AQ         = 28,  //!< EPWM2A AQ submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6A_AQ         = 28,  //!< EPWM6A AQ submodule output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2B_AQ         = 29,  //!< EPWM2B AQ submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6B_AQ         = 29,  //!< EPWM6B AQ submodule output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2A_DB         = 30,  //!< EPWM2A DB submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6A_DB         = 30,  //!< EPWM6A DB submodule output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM2B_DB         = 31,  //!< EPWM2B DB submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6B_DB         = 31,  //!< EPWM6B DB submodule output (CLB2)

    CLB_GLOBAL_IN_MUX_EPWM3A            = 32,  //!< EPWM3A (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7A            = 32,  //!< EPWM7A (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3A_OE         = 33,  //!< EPWM3A trip output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7A_OE         = 33,  //!< EPWM7A trip output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3B            = 34,  //!< EPWM3B (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7B            = 34,  //!< EPWM7B (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3B_OE         = 35,  //!< EPWM3B trip output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7B_OE         = 35,  //!< EPWM7B trip output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_CTR_ZERO    = 36,  //!< EPWM3 TBCTR = Zero (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_CTR_ZERO    = 36,  //!< EPWM7 TBCTR = Zero (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_CTR_PRD     = 37,  //!< EPWM3 TBCTR = TBPRD (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_CTR_PRD     = 37,  //!< EPWM7 TBCTR = TBPRD (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_CTRDIR      = 38,  //!< EPWM3 CTRDIR (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_CTRDIR      = 38,  //!< EPWM7 CTRDIR (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_TBCLK       = 39,  //!< EPWM3 TBCLK (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_TBCLK       = 39,  //!< EPWM7 TBCLK (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_CTR_CMPA    = 40,  //!< EPWM3 TBCTR = CMPA (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_CTR_CMPA    = 40,  //!< EPWM7 TBCTR = CMPA (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_CTR_CMPB    = 41,  //!< EPWM3 TBCTR = CMPB (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_CTR_CMPB    = 41,  //!< EPWM7 TBCTR = CMPB (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_CTR_CMPC    = 42,  //!< EPWM3 TBCTR = CMPC (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_CTR_CMPC    = 42,  //!< EPWM7 TBCTR = CMPC (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3_CTR_CMPD    = 43,  //!< EPWM3 TBCTR = CMPD (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7_CTR_CMPD    = 43,  //!< EPWM7 TBCTR = CMPD (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3A_AQ         = 44,  //!< EPWM3A AQ submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7A_AQ         = 44,  //!< EPWM7A AQ submodule output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3B_AQ         = 45,  //!< EPWM3B AQ submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7B_AQ         = 45,  //!< EPWM7B AQ submodule output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3A_DB         = 46,  //!< EPWM3A DB submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7A_DB         = 46,  //!< EPWM7A DB submodule output (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM3B_DB         = 47,  //!< EPWM3B DB submodule output (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM7B_DB         = 47,  //!< EPWM7B DB submodule output (CLB2)
    ...
    CLB_GLOBAL_IN_MUX_EPWM5A            = 88,  //!< EPWM5A
    CLB_GLOBAL_IN_MUX_EPWM5A_OE         = 89,  //!< EPWM5A trip output
    CLB_GLOBAL_IN_MUX_EPWM5B            = 90,  //!< EPWM5B
    CLB_GLOBAL_IN_MUX_EPWM5B_OE         = 91,  //!< EPWM5B trip output
    CLB_GLOBAL_IN_MUX_EPWM5_CTR_ZERO    = 92,  //!< EPWM5 TBCTR = Zero
    CLB_GLOBAL_IN_MUX_EPWM5_CTR_PRD     = 93,  //!< EPWM5 TBCTR = TBPRD
    CLB_GLOBAL_IN_MUX_EPWM5_CTRDIR      = 94,  //!< EPWM5 CTRDIR
    CLB_GLOBAL_IN_MUX_EPWM5_TBCLK       = 95,  //!< EPWM5 TBCLK
    CLB_GLOBAL_IN_MUX_EPWM5_CTR_CMPA    = 96,  //!< EPWM5 TBCTR = CMPA
    CLB_GLOBAL_IN_MUX_EPWM5_CTR_CMPB    = 97,  //!< EPWM5 TBCTR = CMPB
    CLB_GLOBAL_IN_MUX_EPWM5_CTR_CMPC    = 98,  //!< EPWM5 TBCTR = CMPC
    CLB_GLOBAL_IN_MUX_EPWM5_CTR_CMPD    = 99,  //!< EPWM5 TBCTR = CMPD
    CLB_GLOBAL_IN_MUX_EPWM5A_AQ         = 100, //!< EPWM5A AQ submodule output
    CLB_GLOBAL_IN_MUX_EPWM5B_AQ         = 101, //!< EPWM5B AQ submodule output
    CLB_GLOBAL_IN_MUX_EPWM5A_DB         = 102, //!< EPWM5A DB submodule output
    CLB_GLOBAL_IN_MUX_EPWM5B_DB         = 103, //!< EPWM5B DB submodule output
    ...
    CLB_GLOBAL_IN_MUX_FSIRXA_PING_TAG_MATCH    = 112,  //!< FSIRXA PING TAG Match
    CLB_GLOBAL_IN_MUX_FSIRXA_DATA_TAG_MATCH    = 113,  //!< FSIRXA DATA TAG Match
    CLB_GLOBAL_IN_MUX_FSIRXA_ERROR_TAG_MATCH   = 114,  //!< FSIRXA ERROR TAG Match

    CLB_GLOBAL_IN_MUX_FSIRXA_OUTPUT_FRAME_DONE = 115,  //!< FSIRXA Output Frame Done (CLB1)
    CLB_GLOBAL_IN_MUX_ECAP3_ECAPIN             = 115, //!< ECAP3 ECAPIN (CLB2)
    CLB_GLOBAL_IN_MUX_FSIRXA_DATA_PACKET_RCVD  = 116, //!< FSIRXA Data Packet Received (CLB1)
    CLB_GLOBAL_IN_MUX_ECAP3_ECAP_OUT           = 116, //!< ECAP3 ECAP_OUT (CLB2)
    CLB_GLOBAL_IN_MUX_FSIRXA_ERROR_PACKET_RCVD = 117, //!< FSIRXA Error Packet Received (CLB1)
    CLB_GLOBAL_IN_MUX_ECAP3_ECAP_OUT_EN        = 117, //!< ECAP3 ECAP_OUT_EN (CLB2)
    CLB_GLOBAL_IN_MUX_FSIRXA_PING_PACKET_RCVD  = 118, //!< FSIRXA PING Packet Received (CLB1)
    CLB_GLOBAL_IN_MUX_ECAP3_CEVT1              = 118, //!< ECAP3 CEVT1 (CLB2)
    CLB_GLOBAL_IN_MUX_FSIRXA_PACKET_TAG3       = 119, //!< FSIRXA Packet TAG3 (CLB1)
    CLB_GLOBAL_IN_MUX_ECAP3_CEVT2              = 119, //!< ECAP3 CEVT2 (CLB2)
    CLB_GLOBAL_IN_MUX_SPI1_SPICLK              = 120, //!< SPI1 SPICLK OUT (CLB1)
    CLB_GLOBAL_IN_MUX_ECAP3_CEVT3              = 120, //!< ECAP3 CEVT3 (CLB2)
	CLB_GLOBAL_IN_MUX_SPI1_SPIPOCI_CONTROLLER  = 121, //!< SPI1 SPIPOCI Controller IN (CLB1)
	CLB_GLOBAL_IN_MUX_ECAP3_CEVT4              = 121, //!< ECAP3 CEVT4 (CLB2)
	CLB_GLOBAL_IN_MUX_SPI1_SPIPTE              = 122, //!< SPI1 SPIPTE OUT (CLB1)
	CLB_GLOBAL_IN_MUX_EPWM5_OST                = 122, //!< EPWM5 OST (CLB2)
	CLB_GLOBAL_IN_MUX_SPI2_SPICLK              = 123, //!< SPI2 SPICLK OUT (CLB1)
	CLB_GLOBAL_IN_MUX_EPWM5_CBC                = 123, //!< EPWM5 CBC (CLB2)
	CLB_GLOBAL_IN_MUX_SPI2_SPIPOCI_CONTROLLER  = 124, //!< SPI2 SPIPOCI Controller IN (CLB1)
	CLB_GLOBAL_IN_MUX_EPWM6_OST                = 124, //!< EPWM6 OST (CLB2)
	CLB_GLOBAL_IN_MUX_SPI2_SPIPTE              = 125, //!< SPI2 SPIPTE OUT (CLB1)
    CLB_GLOBAL_IN_MUX_EPWm6_CBC                = 125, //!< EPWM6 CBC (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM5_DCBH               = 126, //!< EPWM5 DCBH (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_DCBH               = 126, //!< EPWM6 DCBH (CLB2)
    CLB_GLOBAL_IN_MUX_EPWM5_DCBL               = 127, //!< EPWM5 DCBL (CLB1)
    CLB_GLOBAL_IN_MUX_EPWM6_DCBL               = 127, //!< EPWM6 DCBL (CLB2)
} CLB_GlobalInputMux;
...
//*****************************************************************************
#ifdef DEBUG
static __always_inline bool CLB_isBaseValid(uint32_t base)
{
    return(
           (base == CLB1_BASE) ||
           (base == CLB2_BASE)
...
//
//*****************************************************************************
static __always_inline bool CLB_isAddressValid(uint32_t address)
{
...
//
//*****************************************************************************
static __always_inline void CLB_enableCLB(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));

    EALLOW;
    HWREG(base + CLB_LOGICCTL + CLB_O_LOAD_EN) |= CLB_LOAD_EN_GLOBAL_EN;
    EDIS;
}
...
//
//*****************************************************************************
static __always_inline void CLB_disableCLB(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_enableNMI(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));

    EALLOW;
    HWREG(base + CLB_LOGICCTL + CLB_O_LOAD_EN) |= CLB_LOAD_EN_NMI_EN;
    EDIS;
}
...
//
//*****************************************************************************
static __always_inline void CLB_disableNMI(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configureClockPrescalar(uint32_t base, uint32_t prescl)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configureStrobeMode(uint32_t base, uint32_t strb)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_writeSWReleaseControl(uint32_t base,
...
//
//*****************************************************************************
static __always_inline void CLB_writeSWGateControl(uint32_t base,
...
//
//*****************************************************************************
static __always_inline void CLB_configCounterTapSelects(uint32_t base, uint32_t tapSel)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configAOC(uint32_t base, CLB_AOCs aocID,
                                     uint32_t aocCfg)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_enableLock(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_writeInterface(uint32_t base, uint32_t address,
                                      uint32_t value)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_selectInputFilter(uint32_t base, CLB_Inputs inID,
...
//
//*****************************************************************************
static __always_inline void CLB_enableSynchronization(uint32_t base, CLB_Inputs inID)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_disableSynchronization(uint32_t base, CLB_Inputs inID)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configGPInputMux(uint32_t base, CLB_Inputs inID,
...
//
//*****************************************************************************
static __always_inline void CLB_setGPREG(uint32_t base, uint32_t gpRegVal)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline uint32_t CLB_getGPREG(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configLocalInputMux(uint32_t base, CLB_Inputs inID,
                                            CLB_LocalInputMux localMuxCfg)
{
    ...
    // shift amount accordingly.
    //
    shiftVal = (uint32_t)inID * CLB_LCL_MUX_SEL_1_LCL_MUX_SEL_IN_1_S;
...
//
//*****************************************************************************
static __always_inline void CLB_configGlobalInputMux(uint32_t base, CLB_Inputs inID,
                                            CLB_GlobalInputMux globalMuxCfg)
{
    ...
    // shift amount accordingly.
    //
    shiftVal = (uint32_t)inID * CLB_GLBL_MUX_SEL_1_GLBL_MUX_SEL_IN_1_S;
...
//
//*****************************************************************************
static __always_inline void CLB_setOutputMask(uint32_t base, uint32_t outputMask ,
                                             bool enable)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline uint32_t CLB_getInterruptTag(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));

    return(HWREG(base + CLB_LOGICCTL + CLB_O_INTR_TAG_REG));
}
...
//
//*****************************************************************************
static __always_inline void CLB_clearInterruptTag(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));

    HWREG(base + CLB_LOGICCTL + CLB_O_INTR_TAG_REG) = 0U;
}
...
//
//*****************************************************************************
static __always_inline void CLB_selectLUT4Inputs(uint32_t base, uint32_t lut4In0,
...
//
//*****************************************************************************
static __always_inline void CLB_configLUT4Function(uint32_t base, uint32_t lut4Fn10,
                                          uint32_t lut4Fn2)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_selectFSMInputs(uint32_t base, uint32_t external0,
...
//
//*****************************************************************************
static __always_inline void CLB_configFSMLUTFunction(uint32_t base, uint32_t fsmLutFn10,
                                            uint32_t fsmLutFn2)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configFSMNextState(uint32_t base, uint32_t nextState0,
                                          uint32_t nextState1,
                                          uint32_t nextState2)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_selectCounterInputs(uint32_t base, uint32_t reset,
...
//
//*****************************************************************************
static __always_inline void CLB_configMiscCtrlModes(uint32_t base, uint32_t miscCtrl)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configOutputLUT(uint32_t base, CLB_Outputs outID,
                                       uint32_t outputCfg)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configHLCEventSelect(uint32_t base, uint32_t eventSel)
{
    ASSERT(CLB_isBaseValid(base));
...
//*****************************************************************************
//
//! Configures HLC event edge selection.
//!
//! \param base is the base address of a CLB tile's logic config register.
//! \param eventedgeSel is the value for HLC event edge selection. 
//!
//! This function configures the event selection for the High Level Controller.
//!
//! \return None.
//
//*****************************************************************************
static __always_inline void CLB_configHLCEventedgeSelect(uint32_t base, uint32_t eventedgeSel)
{
    ASSERT(CLB_isBaseValid(base));

    EALLOW;
    HWREG(base + CLB_O_HLC_EVENT_CTRL) |= (eventedgeSel & \
    				(CLB_HLC_EVENT_CTRL_EVENT0_EDGE_SEL | \
    				CLB_HLC_EVENT_CTRL_EVENT1_EDGE_SEL | \
					CLB_HLC_EVENT_CTRL_EVENT2_EDGE_SEL | \
					CLB_HLC_EVENT_CTRL_EVENT3_EDGE_SEL));
    EDIS;
}
...
//
//*****************************************************************************
static __always_inline void CLB_programHLCInstruction(uint32_t base,
...
//
//*****************************************************************************
static __always_inline void CLB_setHLCRegisters(uint32_t base, uint32_t r0Init,
...
//
//*****************************************************************************
static __always_inline uint32_t CLB_getRegister(uint32_t base, CLB_Register registerID)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline uint32_t CLB_getOutputStatus(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_enablePipelineMode(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));

    EALLOW;
    HWREG(base + CLB_LOGICCTL + CLB_O_LOAD_EN) |= CLB_LOAD_EN_PIPELINE_EN;
    EDIS;
}
...
//
//*****************************************************************************
static __always_inline void CLB_disablePipelineMode(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_disableOutputMaskUpdates(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));

    EALLOW;
    HWREG(base + CLB_O_MISC_ACCESS_CTRL) |= CLB_MISC_ACCESS_CTRL_BLKEN;
    EDIS;
}
...
//
//*****************************************************************************
static __always_inline void CLB_enableOutputMaskUpdates(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_enableInputPipelineMode(uint32_t base, CLB_Inputs inID)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_disableInputPipelineMode(uint32_t base, CLB_Inputs inID)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_disableSPIBufferAccess(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));

    EALLOW;
    HWREG(base + CLB_O_MISC_ACCESS_CTRL) &= ~CLB_MISC_ACCESS_CTRL_SPIEN;
    EDIS;
}
...
//
//*****************************************************************************
static __always_inline void CLB_enableSPIBufferAccess(uint32_t base)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static __always_inline void CLB_configSPIBufferLoadSignal(uint32_t base, uint32_t eventSel)
{
    ASSERT(CLB_isBaseValid(base));
	...
	if(eventSel < 32)
	{
	    HWREG(base + CLB_O_HLC_EVENT_CTRL) &= ~CLB_HLC_EVENT_CTRL_SPI_DATA_STRB_EXTND;
	}
	else if((eventSel >= 32)&(eventSel < 64))
	{
	    HWREG(base + CLB_O_HLC_EVENT_CTRL) |= CLB_HLC_EVENT_CTRL_SPI_DATA_STRB_EXTND;
		eventSel = eventSel - 32;
	}
    HWREG(base + CLB_O_SPI_DATA_CTRL_HI) =
        (HWREG(base + CLB_O_SPI_DATA_CTRL_HI) &
         ~((uint32_t)CLB_SPI_DATA_CTRL_HI_STRB_M << CLB_SPI_DATA_CTRL_HI_STRB_S)) |
        ((uint32_t)eventSel << CLB_SPI_DATA_CTRL_HI_STRB_S);
    EDIS;
}
...
//
//*****************************************************************************
static __always_inline void CLB_configSPIBufferShift(uint32_t base, uint32_t shiftVal)
{
    ASSERT(CLB_isBaseValid(base));
    ...
    HWREG(base + CLB_O_SPI_DATA_CTRL_HI) =
        (HWREG(base + CLB_O_SPI_DATA_CTRL_HI) &
         ~((uint32_t)CLB_SPI_DATA_CTRL_HI_SHIFT_M << CLB_SPI_DATA_CTRL_HI_SHIFT_S)) |
        ((uint32_t)shiftVal << CLB_SPI_DATA_CTRL_HI_SHIFT_S);
    EDIS;
}
