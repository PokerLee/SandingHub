...
//! \file   /libraries/observers/est_lib/include/userParams.h
//! \brief  Contains the public interface for the
//!         HAL and EST modules
//!
...
//*****************************************************************************
//
//! \defgroup USERPARAMS_LIB USERPARAMS_LIB
//! @{
//
//*****************************************************************************
...
typedef struct _USER_Params_
{
    ...
    int_least16_t numCtrlTicksPerSpeedTick;
                                        ...
                                        //!< clock tick
    int_least16_t numCtrlTicksPerPosTick;
                                        //!< Defines the number of controller
                                        //!< clock ticks per position controller
                                        //!< clock tick
    ...
    float32_t systemFreq_MHz;             //!< Defines the system clock
                                        //!< frequency, MHz
    float32_t pwmPeriod_Hz;             //!< Defines the Pulse Width Modulation
                                        //!< (PWM) period, usec
...
//! \brief Defines the USER_Params handle
//!
typedef struct _USER_Params_ *userParams_Handle;
