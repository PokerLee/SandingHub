...
#define USER_M1_NOMINAL_DC_BUS_VOLTAGE_V         (7.65f)
...
#define USER_M1_ADC_FULL_SCALE_CURRENT_A         (5.5f)     // gain=20
...
//!
//#define USER_M1_MAX_VS_MAG_PU            (0.66)   // 最大外接圆
#define USER_M1_MAX_VS_MAG_PU              (0.576)	// 最大内切圆
...
#define USER_MOTOR1_ALIGN_CURRENT_A        (20.0f)           // A
...
// only for encoder
#define USER_MOTOR1_ENC_FSPEED_WINDOW	   (0.1)		// 单位 s
...
#define MOTOR_CHOICE_SANDING_14PAIRS   	0
#define MOTOR_CHOICE_GL35_KV100_7PAIRS	0
#define MOTOR_CHOICE_GL40_KV70_14PAIRS	1
//------------------------------------------------------------------
...
#if MOTOR_CHOICE_GL35_KV100_7PAIRS
#define USER_MOTOR1_TYPE                   MOTOR_TYPE_PM
...
#if MOTOR_CHOICE_GL40_KV70_14PAIRS
#define USER_MOTOR1_TYPE                   MOTOR_TYPE_PM
#define USER_MOTOR1_NUM_POLE_PAIRS         (14)
#define USER_MOTOR1_GERAR_RATIO			   (6)
#define USER_MOTOR1_Rr_Ohm                 (0)
#define USER_MOTOR1_Rs_Ohm                 (0.044586122)
#define USER_MOTOR1_Ls_d_H                 (1.03E-6)
#define USER_MOTOR1_Ls_q_H                 (1.03E-6)
