...
//------------------------------------------------------------------------------
// EQEP
#define MTR1_EQEP_ENCODER_BASE	EQEP1_BASE
...
#define MTR1_ADC_I_SAMPLEWINDOW     8
#define MTR1_ADC_V_SAMPLEWINDOW     8
...
#define MTR1_VV_ADC_BASE        ADCC_BASE               // ADCC-A3*/C5
...
#define MTR1_VV_ADCRES_BASE     ADCCRESULT_BASE         // ADCC-A3*/C5
...
#define MTR1_VV_ADC_CH_NUM      ADC_CH_ADCIN5           // ADCC-A3*/C5
...
#define MTR1_IW_ADC_SOC_NUM     ADC_SOC_NUMBER3         // ADCC-A15/C7* -SOC2-PPB2
#define MTR1_VU_ADC_SOC_NUM     ADC_SOC_NUMBER3         // ADCA-A6*     -SOC4
#define MTR1_VV_ADC_SOC_NUM     ADC_SOC_NUMBER5         // ADCC-A3*/C5  -SOC5
#define MTR1_VW_ADC_SOC_NUM     ADC_SOC_NUMBER5         // ADCA-A2/C9*  -SOC5
#define MTR1_VDC_ADC_SOC_NUM    ADC_SOC_NUMBER7         // ADCC-C6*     -SOC6
...
//#define MTR1_POT_ADC_CH_NUM     ADC_CH_ADCIN12          // ADCA-A12*/C1
//
//#define MTR1_IU_ADC_SOC_NUM     ADC_SOC_NUMBER7         // ADCA-A11*/C10-SOC1-PPB1
//#define MTR1_IV_ADC_SOC_NUM     ADC_SOC_NUMBER9         // ADCC-A14/C4* -SOC1-PPB1
//#define MTR1_IW_ADC_SOC_NUM     ADC_SOC_NUMBER11         // ADCC-A15/C7* -SOC2-PPB2
//#define MTR1_VU_ADC_SOC_NUM     ADC_SOC_NUMBER9         // ADCA-A6*     -SOC4
//#define MTR1_VV_ADC_SOC_NUM     ADC_SOC_NUMBER11         // ADCC-A3*/C5  -SOC5
//#define MTR1_VW_ADC_SOC_NUM     ADC_SOC_NUMBER13         // ADCA-A2/C9*  -SOC5
//#define MTR1_VDC_ADC_SOC_NUM    ADC_SOC_NUMBER15         // ADCC-C6*     -SOC6
//#define MTR1_POT_ADC_SOC_NUM    ADC_SOC_NUMBER6         // ADCA-A12*/C1 -SOC6
//
//#define MTR1_IU_ADC_PPB_NUM     ADC_PPB_NUMBER1         // ADCA-A11*/C10-SOC1-PPB1
//#define MTR1_IV_ADC_PPB_NUM     ADC_PPB_NUMBER1         // ADCC-A14/C4* -SOC1-PPB1
...
#define MTR1_ADC_INT_SOC        MTR1_VDC_ADC_SOC_NUM    // ADCC_INT1-SOC6
...
#define MTR2_CMPSS_IDC_BASE     CMPSS3_BASE

#define MTR2_CMPSS_U_BASE       CMPSS1_BASE
#define MTR2_CMPSS_V_BASE       CMPSS3_BASE
#define MTR2_CMPSS_W_BASE       CMPSS1_BASE

#define MTR2_XBAROUTPUT         XBAR_OUTPUT8
...
//! \brief Defines the gpio for the SPI_CS of DRV device
#define MTR2_DRV_SPI_CS_GPIO    32

//! \brief Defines the gpio for calibration
#define MTR2_GATE_CAL_GPIO      46

#define MTR2_SPI_BASE           SPIB_BASE

//------------------------------------------------------------------------------
// ADC
// Three-shunt
#define MTR2_ADC_TIGGER_SOC     ADC_TRIGGER_EPWM7_SOCA  // EPWM1_SOCA
#define MTR2_ADC_I_SAMPLEWINDOW     8
#define MTR2_ADC_V_SAMPLEWINDOW     8

#define MTR2_IU_ADC_BASE        ADCA_BASE               // ADCA-A10*/C10
#define MTR2_IV_ADC_BASE        ADCC_BASE               // ADCC-A4/C14*
#define MTR2_IW_ADC_BASE        ADCC_BASE               // ADCC-A9/C8*
#define MTR2_VU_ADC_BASE        ADCA_BASE               // ADCA-A5*/C2
#define MTR2_VV_ADC_BASE        ADCA_BASE               // ADCA_A7*/C3
#define MTR2_VW_ADC_BASE        ADCC_BASE               // ADCC_A8/C11*
#define MTR2_VDC_ADC_BASE       ADCA_BASE               // ADCA-A1*
#define MTR2_POT_ADC_BASE       ADCC_BASE               // ADCC-A0/C15*

#define MTR2_IU_ADCRES_BASE     ADCARESULT_BASE         // ADCA-A10*/C10
#define MTR2_IV_ADCRES_BASE     ADCCRESULT_BASE         // ADCC-A4/C14*
#define MTR2_IW_ADCRES_BASE     ADCCRESULT_BASE         // ADCC-A9/C8*
#define MTR2_VU_ADCRES_BASE     ADCARESULT_BASE         // ADCA-A5*/C2
#define MTR2_VV_ADCRES_BASE     ADCARESULT_BASE         // ADCA_A7*/C3
#define MTR2_VW_ADCRES_BASE     ADCCRESULT_BASE         // ADCC_A8/C11*
#define MTR2_VDC_ADCRES_BASE    ADCARESULT_BASE         // ADCA-A1*
#define MTR2_POT_ADCRES_BASE    ADCCRESULT_BASE         // ADCC-A0/C15*

#define MTR2_IU_ADC_CH_NUM      ADC_CH_ADCIN10          // ADCA-A10*/C10
#define MTR2_IV_ADC_CH_NUM      ADC_CH_ADCIN14          // ADCC-A4/C14*
#define MTR2_IW_ADC_CH_NUM      ADC_CH_ADCIN8           // ADCC-A9/C8*
#define MTR2_VU_ADC_CH_NUM      ADC_CH_ADCIN5           // ADCA-A5*/C2
#define MTR2_VV_ADC_CH_NUM      ADC_CH_ADCIN7           // ADCA_A7*/C3
#define MTR2_VW_ADC_CH_NUM      ADC_CH_ADCIN11          // ADCC_A8/C11*
#define MTR2_VDC_ADC_CH_NUM     ADC_CH_ADCIN1           // ADCA-A1*
#define MTR2_POT_ADC_CH_NUM     ADC_CH_ADCIN15          // ADCC-A0/C15*

#define MTR2_IU_ADC_SOC_NUM     ADC_SOC_NUMBER7         // ADCA-A10*/C10-SOC7-PPB3
#define MTR2_IV_ADC_SOC_NUM     ADC_SOC_NUMBER11        // ADCC-A4/C14* -SOC8-PPB4
#define MTR2_IW_ADC_SOC_NUM     ADC_SOC_NUMBER9         // ADCC-A9/C8*  -SOC7-PPB3
#define MTR2_VU_ADC_SOC_NUM     ADC_SOC_NUMBER9         // ADCA-A5*/C2  -SOC10
#define MTR2_VV_ADC_SOC_NUM     ADC_SOC_NUMBER11        // ADCA_A7*/C3  -SOC11
#define MTR2_VW_ADC_SOC_NUM     ADC_SOC_NUMBER13        // ADCC_A8/C11* -SOC11
#define MTR2_VDC_ADC_SOC_NUM    ADC_SOC_NUMBER13        // ADCA-A1*     -SOC12
#define MTR2_POT_ADC_SOC_NUM    ADC_SOC_NUMBER12        // ADCC-A0/C15* -SOC12

#define MTR2_IU_ADC_PPB_NUM     ADC_PPB_NUMBER3         // ADCA-A10*/C10-SOC7-PPB3
#define MTR2_IV_ADC_PPB_NUM     ADC_PPB_NUMBER3         // ADCC-A9/C8*  -SOC7-PPB3
#define MTR2_IW_ADC_PPB_NUM     ADC_PPB_NUMBER4         // ADCC-A4/C14*- SOC8-PPB4
//------------------------------------------------------------------------------
// interrupt
#define MTR2_PWM_INT_BASE       MTR1_PWM_U_BASE         // EPWM1

#define MTR2_ADC_INT_BASE       ADCC_BASE               // ADCC-C6  -SOC6
#define MTR2_ADC_INT_NUM        ADC_INT_NUMBER1         // ADCC_INT1-SOC6
#define MTR2_ADC_INT_SOC        ADC_SOC_NUMBER6         // ADCC_INT1-SOC6

#define MTR2_PIE_INT_NUM        INT_ADCC1               // ADCC_INT1-SOC6
#define MTR2_CPU_INT_NUM        INTERRUPT_CPU_INT1      // ADCC_INT1-CPU_INT1
#define MTR2_INT_ACK_GROUP      INTERRUPT_ACK_GROUP1    // ADCC_INT1-CPU_INT1

//------------------------------------------------------------------------------
// CMPSS
#define MTR2_IDC_CMPHP_SEL      ASYSCTL_CMPHPMUX_SELECT_4    // CMPSS4-A9/C8*
#define MTR2_IDC_CMPLP_SEL      ASYSCTL_CMPLPMUX_SELECT_4    // CMPSS4-A9/C8*

#define MTR2_IDC_CMPHP_MUX      0                            // CMPSS4-A9/C8*
#define MTR2_IDC_CMPLP_MUX      0                            // CMPSS4-A9/C8*

#define MTR2_IU_CMPHP_SEL       ASYSCTL_CMPHPMUX_SELECT_2    // CMPSS2-A10*/C10
#define MTR2_IU_CMPLP_SEL       ASYSCTL_CMPLPMUX_SELECT_2    // CMPSS2-A10*/C10

#define MTR2_IU_CMPHP_MUX       3                            // CMPSS2-A10*/C10
#define MTR2_IU_CMPLP_MUX       3                            // CMPSS2-A10*/C10

#define MTR2_IV_CMPHP_SEL       ASYSCTL_CMPHPMUX_SELECT_4    // CMPSS4-A9/C8*
#define MTR2_IV_CMPLP_SEL       ASYSCTL_CMPLPMUX_SELECT_4    // CMPSS4-A9/C8*

#define MTR2_IV_CMPHP_MUX       0                            // CMPSS4-A9/C8*
#define MTR2_IV_CMPLP_MUX       0                            // CMPSS4-A9/C8*

#define MTR2_IW_CMPHP_SEL       ASYSCTL_CMPHPMUX_SELECT_2    // CMPSS2-A4/C14*
#define MTR2_IW_CMPLP_SEL       ASYSCTL_CMPLPMUX_SELECT_2    // CMPSS2-A4/C14*

#define MTR2_IW_CMPHP_MUX       0                            // CMPSS2-A4/C14*
#define MTR2_IW_CMPLP_MUX       0                            // CMPSS2-A4/C14*
...
//------------------------------------------------------------------------------
// XBAR-EPWM
#define MTR2_XBAR_TRIP_ADDRL    XBAR_O_TRIP7MUX0TO15CFG
#define MTR2_XBAR_TRIP_ADDRH    XBAR_O_TRIP7MUX16TO31CFG

#define MTR2_IDC_XBAR_EPWM_MUX  XBAR_EPWM_MUX07_CMPSS4_CTRIPL   // CMPSS4-LP
#define MTR2_IDC_XBAR_MUX       XBAR_MUX07                      // CMPSS4-LP

#define MTR2_IU_XBAR_EPWM_MUX   XBAR_EPWM_MUX02_CMPSS2_CTRIPH       // CMPSS2-HP
#define MTR2_IV_XBAR_EPWM_MUX   XBAR_EPWM_MUX06_CMPSS4_CTRIPH_OR_L  // CMPSS4-HP&LP
#define MTR2_IW_XBAR_EPWM_MUX   XBAR_EPWM_MUX03_CMPSS2_CTRIPL       // CMPSS2-LP

#define MTR2_IU_XBAR_MUX        XBAR_MUX02          // CMPSS2-HP
#define MTR2_IV_XBAR_MUX        XBAR_MUX06          // CMPSS4-HP&LP
#define MTR2_IW_XBAR_MUX        XBAR_MUX03          // CMPSS2-LP

#define MTR2_XBAR_INPUT2        XBAR_INPUT2
#define MTR2_TZ_OSHT1           EPWM_TZ_SIGNAL_OSHT1

#define MTR2_XBAR_TRIP          XBAR_TRIP8
#define MTR2_DCTRIPIN           EPWM_DC_COMBINATIONAL_TRIPIN8

#define MTR2_IU_XBAR_OUT_MUX    XBAR_OUT_MUX02_CMPSS2_CTRIPOUTH       // CMPSS2-HP
#define MTR2_IV_XBAR_OUT_MUX    XBAR_OUT_MUX06_CMPSS4_CTRIPOUTH_OR_L  // CMPSS4-HP&LP
#define MTR2_IW_XBAR_OUT_MUX    XBAR_OUT_MUX03_CMPSS2_CTRIPOUTL       // CMPSS2-LP

//! \brief Defines the PWM deadband falling edge delay count (system clocks)
#define MTR2_PWM_DBFED_CNT      8//5           // 50ns

//! \brief Defines the PWM deadband rising edge delay count (system clocks)
#define MTR2_PWM_DBRED_CNT      8//5           // 50ns
...
extern __interrupt  void xint3ISR(void);
extern __interrupt  void lin0ISR(void);
...
extern void HAL_init(void *pMemory);
...
//! \brief     Sets up the LIN
//! \param[in] handle  The hardware abstraction layer (HAL) handle
extern void HAL_setupLIN(HAL_Handle halHandle);
