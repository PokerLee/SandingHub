...
//*****************************************************************************
static __always_inline void
HIC_setPinPolarity(uint32_t flags)
{
...
//*****************************************************************************
static __always_inline void
HIC_selectBaseAddress(uint32_t selectIndex)
{
    //
    //Check the arguments.
    //
...
{
    return(HWREG(HIC_BASE + HIC_O_BASESEL));
}
...
//*****************************************************************************
static __always_inline void
HIC_configureHostAccessMode(uint32_t config)
{
...
HIC_getHostAccessMode(void)
{
    ...
    //
    return(HWREG(HIC_BASE + HIC_O_HOSTCR));
}
...
//*****************************************************************************
static __always_inline void
HIC_setBaseAddress(uint32_t index,
                uint32_t baseAddress)
{
    ...
    EALLOW;
    HWREG(HIC_BASE + HIC_O_DBADDR0 + (index * 4)) = baseAddress;
    EDIS;
}
...
//*****************************************************************************
static __always_inline uint32_t
HIC_getBaseAddress(uint32_t index)
{
    //
    //Check the arguments.
    //
    ...
    return(HIC_BASE + HIC_O_DBADDR0 + (index * 4));
}
...
//*****************************************************************************
static __always_inline uint32_t
HIC_readH2DBuffer(uint32_t offset)
{
    //
    //Check the arguments.
    //
    ...
    return(HWREG(HIC_BASE + HIC_O_H2D_BUF0 + (offset * 4)));
}
...
//*****************************************************************************
static __always_inline void
HIC_writeH2DBuffer(uint32_t offset, uint32_t data)
{
    //
    //Check the arguments.
    //
    ...
    HWREG(HIC_BASE + HIC_O_H2D_BUF0 + (offset * 4)) = data;
}
...
//*****************************************************************************
static __always_inline void
HIC_clearH2DBuffer(uint32_t offset)
{
    //
    //Check the arguments.
    //
    ...
    HWREG(HIC_BASE + HIC_O_H2D_BUF0 + (offset * 4)) = 0;
}
...
//*****************************************************************************
static __always_inline uint32_t
HIC_readD2HBuffer(uint32_t offset)
{
    //
    //Check the arguments.
    //
    ...
    return(HWREG(HIC_BASE + HIC_O_D2H_BUF0 + (offset * 4)));
}
...
//*****************************************************************************
static __always_inline void
HIC_writeD2HBuffer(uint32_t offset, uint32_t data)
{
    //
    //Check the arguments.
    //
    ...
    HWREG(HIC_BASE + HIC_O_D2H_BUF0 + (offset * 4)) = data;
}
...
//*****************************************************************************
static __always_inline void
HIC_clearD2HBuffer(uint32_t offset)
{
    //
    //Check the arguments.
    //
    ...
    HWREG(HIC_BASE + HIC_O_D2H_BUF0 + (offset * 4)) = 0U;
}
