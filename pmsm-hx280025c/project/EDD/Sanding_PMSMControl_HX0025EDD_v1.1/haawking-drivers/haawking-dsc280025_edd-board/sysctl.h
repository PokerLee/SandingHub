...
//
#define SYSCTL_BOOT_ROM_STATUS    0x0010U
...
// analog peripherals
//
#define PMUTrims_cal ((void (*)(void))((uintptr_t)0x7eaa98))
#define OscTrims_cal ((void (*)(void))((uintptr_t)0x7eabb8))
#define AdcTrims_cal ((void (*)(void))((uintptr_t)0x7eace2))
...
//
#define SYSCTL_SYSDIV_M     0x00003F00U // Mask for SYSDIV value in config
#define SYSCTL_SYSDIV_S     8U          // Shift for SYSDIV value in config

//
// Mask and shift for Reference Clock Divider value in config
//
#define SYSCTL_REFDIV_M      0x007C0000U // Mask for Reference Clock Divider
...
//
#define SYSCTL_ODIV_M        (uint32_t)0x01800000U

#define SYSCTL_ODIV_S        23U

//! Macro to format Clock divider value. x is a number from 1 to 32.
//!
#define SYSCTL_REFDIV(x)     ((((uint32_t)(x)) << SYSCTL_REFDIV_S) &      \
                                  SYSCTL_REFDIV_M)

//! Macro to format Clock divider value. x is a number from 1 to 32.
//!
#define SYSCTL_ODIV(x)       ((((uint32_t)(x)) << SYSCTL_ODIV_S) &        \
                                  SYSCTL_ODIV_M)
...
//
#define SYSCTL_IMULT_M      (uint32_t)0x000000FFU
...
#define SYSCTL_VCO_M      (uint32_t)0x00E000000U
#define SYSCTL_VCO_S      25U          // Shift for IMULT value in config

#define SYSCTL_VCO(x)        (((x) << SYSCTL_VCO_S)&SYSCTL_VCO_M)
...
#define SYSCTL_FMULT_1_4    0x00004000U //!< Fractional multiplier of 0.25
#define SYSCTL_FMULT_1_2    0x00008000U //!< Fractional multiplier of 0.50
#define SYSCTL_FMULT_3_4    0x0000C000U //!< Fractional multiplier of 0.75
...
typedef enum
{
	...
	SYSCTL_PERIPH_CLK_HRCAP = 0x0802,     //!< HRCAP3 clock
	...
	SYSCTL_PERIPH_CLK_I2SA = 0x0030        //!< I2S clock
...
typedef enum
{
	...
	SYSCTL_PERIPH_RES_I2SA = 0x0020  //!< Reset I2S_A clock
...
typedef enum
{
    ...
    SYSCTL_ACCESS_ADCC          = 0x8,   //!< ADCC access
    SYSCTL_ACCESS_CMPSS1        = 0x20,  //!< CMPSS1 access
    SYSCTL_ACCESS_CMPSS2        = 0x24,  //!< CMPSS2 access
    SYSCTL_ACCESS_CMPSS3        = 0x28,  //!< CMPSS3 access
    SYSCTL_ACCESS_CMPSS4        = 0x2C,  //!< CMPSS4 access
    SYSCTL_ACCESS_EPWM1         = 0x30,  //!< EPWM1 access
    SYSCTL_ACCESS_EPWM2         = 0x34,  //!< EPWM2 access
    SYSCTL_ACCESS_EPWM3         = 0x38,  //!< EPWM3 access
    SYSCTL_ACCESS_EPWM4         = 0x3C,  //!< EPWM4 access
    SYSCTL_ACCESS_EPWM5         = 0x40,  //!< EPWM5 access
    SYSCTL_ACCESS_EPWM6         = 0x44,  //!< EPWM6 access
    SYSCTL_ACCESS_EPWM7         = 0x48,  //!< EPWM7 access
    SYSCTL_ACCESS_EQEP1         = 0xE0,  //!< EQEP1 access
    SYSCTL_ACCESS_EQEP2         = 0xE4,  //!< EQEP2 access
    SYSCTL_ACCESS_ECAP1         = 0x100, //!< ECAP1 access
    SYSCTL_ACCESS_ECAP2         = 0x104, //!< ECAP2 access
    SYSCTL_ACCESS_ECAP3         = 0x108, //!< ECAP3 access
    SYSCTL_ACCESS_CLB1          = 0x160, //!< CLB1 access
    SYSCTL_ACCESS_CLB2          = 0x164, //!< CLB2 access
    SYSCTL_ACCESS_SCIA          = 0x200, //!< SCIA access
    SYSCTL_ACCESS_SPIA          = 0x220, //!< SPIA access
    SYSCTL_ACCESS_SPIB          = 0x224, //!< SPIB access
    SYSCTL_ACCESS_I2CA          = 0x240, //!< I2CA access
    SYSCTL_ACCESS_I2CB          = 0x244, //!< I2CB access
    SYSCTL_ACCESS_PMBUSA        = 0x260, //!< PMBUS_A access
    SYSCTL_ACCESS_LINA          = 0x270, //!< LIN_A access
    SYSCTL_ACCESS_LINB          = 0x274, //!< LIN_B access
    SYSCTL_ACCESS_CANA          = 0x280, //!< DCANA access
    SYSCTL_ACCESS_FSIATX        = 0x2B0, //!< FSIATX access
    SYSCTL_ACCESS_FSIARX        = 0x2B4, //!< FSIARX access
    SYSCTL_ACCESS_HRPWMA        = 0x354, //!< HRPWM_A access
	SYSCTL_ACCESS_HICA          = 0x358, //!< HIC_A access
	SYSCTL_ACCESS_I2SA          = 0x35C  //!< I2S_A access
...
SysCtl_resetPeripheral(SysCtl_PeripheralSOFTPRES peripheral)
{
    ...
    //
    regIndex = (uint32_t)4U * ((uint32_t)peripheral &
                               (uint32_t)SYSCTL_PERIPH_REG_M);
    bitIndex = ((uint32_t)peripheral & SYSCTL_PERIPH_BIT_M) >>
               SYSCTL_PERIPH_BIT_S;
...
SysCtl_resetDevice(void)
{
    ...
    // Enable the watchdog
    //
    HWREG(WD_BASE + SYSCTL_O_WDCR) = SYSCTL_WD_CHKBITS;
    //
    // Write a bad check value
    //
    HWREG(WD_BASE + SYSCTL_O_WDCR) = 0U;
...
SysCtl_selectClockOutSource(SysCtl_ClockOut source)
{
    ...
    //
    HWREG(CLKCFG_BASE + SYSCTL_O_CLKSRCCTL3) &=
        ~SYSCTL_CLKSRCCTL3_XCLKOUTSEL_M;

    //
    // Set clock out source
    //
    HWREG(CLKCFG_BASE + SYSCTL_O_CLKSRCCTL3) |= (uint32_t)source;
...
{
    return(HWREG(CLKCFG_BASE + SYSCTL_O_X1CNT) & SYSCTL_X1CNT_X1CNT_M);
}
...
//*****************************************************************************
static __always_inline void
SysCtl_setStandbyQualificationPeriod(uint32_t cycles)
{
    //
    // Check the arguments.
    //
    ...
    HWREG(CPUSYS_BASE + SYSCTL_O_LPMCR) =
                (HWREG(CPUSYS_BASE + SYSCTL_O_LPMCR) &
                 ~(uint32_t)SYSCTL_LPMCR_QUALSTDBY_M) |
                ((cycles - (uint32_t)2U) << SYSCTL_LPMCR_QUALSTDBY_S);
...
SysCtl_enableWatchdogStandbyWakeup(void)
{
    ...
    //
    HWREG(CPUSYS_BASE + SYSCTL_O_LPMCR) |= SYSCTL_LPMCR_WDINTE;
...
SysCtl_enableWatchdogInHalt(void)
{
    ...
    //
    HWREG(CLKCFG_BASE + SYSCTL_O_CLKSRCCTL1) |= SYSCTL_CLKSRCCTL1_WDHALTI;
...
SysCtl_setWatchdogMode(SysCtl_WDMode mode)
{
    ...
    {
        HWREG(WD_BASE + SYSCTL_O_SCSR) =
                (HWREG(WD_BASE + SYSCTL_O_SCSR) & ~SYSCTL_SCSR_WDOVERRIDE) |
                SYSCTL_SCSR_WDENINT;
    }
    else
    {
        HWREG(WD_BASE + SYSCTL_O_SCSR) &= ~(SYSCTL_SCSR_WDENINT |
...
SysCtl_isWatchdogInterruptActive(void)
{
    ...
    //
    return((HWREG(WD_BASE + SYSCTL_O_SCSR) & SYSCTL_SCSR_WDINTS) == 0U);
}
...
SysCtl_enableWatchdog(void)
{
    ...
    //
    HWREG(WD_BASE + SYSCTL_O_WDCR) = (HWREG(WD_BASE + SYSCTL_O_WDCR) &
                                       ~(SYSCTL_WDCR_WDDIS | 0x80)) | SYSCTL_WD_CHKBITS;
...
SysCtl_isWatchdogEnabled(void)
{
    ...
    //
    return ((HWREG(WD_BASE + SYSCTL_O_WDCR) & SYSCTL_WDCR_WDDIS) == 0U);
}
...
SysCtl_setWatchdogPredivider(SysCtl_WDPredivider predivider)
{
    ...
    regVal = (uint32_t)predivider | (uint32_t)SYSCTL_WD_CHKBITS;
    ...
    //
    HWREG(WD_BASE + SYSCTL_O_WDCR) = (HWREG(WD_BASE + SYSCTL_O_WDCR) &
                                       ~(SYSCTL_WDCR_WDPRECLKDIV_M | 0x80)) | regVal;
...
SysCtl_setWatchdogPrescaler(SysCtl_WDPrescaler prescaler)
{
    ...
    regVal = (uint32_t)prescaler | (uint32_t)SYSCTL_WD_CHKBITS;
    ...
    //
    HWREG(WD_BASE + SYSCTL_O_WDCR) = (HWREG(WD_BASE + SYSCTL_O_WDCR) &
                                       ~(SYSCTL_WDCR_WDPS_M | 0x80)) | regVal;
...
SysCtl_getWatchdogCounterValue(void)
{
    ...
    //
    return(HWREG(WD_BASE + SYSCTL_O_WDCNTR));
}
...
SysCtl_getWatchdogResetStatus(void)
{
    ...
    //
    return((HWREG(CPUSYS_BASE + SYSCTL_O_RESC) & SYSCTL_RESC_WDRSN) != 0U);
}
...
SysCtl_clearWatchdogResetStatus(void)
{
    ...
    // Read and return the status of the watchdog reset status flag.
    //
    HWREG(CPUSYS_BASE + SYSCTL_O_RESCCLR) = SYSCTL_RESCCLR_WDRSN;
...
//*****************************************************************************
static __always_inline void
SysCtl_setWatchdogWindowValue(uint32_t value)
{
    EALLOW;
    ...
    //
    HWREG(WD_BASE + SYSCTL_O_WDWCR) &= ~SYSCTL_WDWCR_MIN_M;

    //
    // Set the windowed value
    //
    HWREG(WD_BASE + SYSCTL_O_WDWCR) |= (value & SYSCTL_WDWCR_MIN_M);
...
SysCtl_enableNMIGlobalInterrupt(void)
{
    ...
    HWREG(0x5330) = 1;
    HWREG(NMI_BASE + NMI_O_CFG) |= NMI_CFG_NMIE;
...
SysCtl_getNMIStatus(void)
{
    ...
    // all but the NMI bit.
    //
    return((HWREG(NMI_BASE + NMI_O_FLG) & NMI_FLG_NMIINT) != 0U);
}
...
SysCtl_isNMIFlagSet(uint32_t nmiFlags)
{
    ...
    //
    return((HWREG(NMI_BASE + NMI_O_FLG) & nmiFlags) != 0U);
}
...
SysCtl_clearNMIStatus(uint32_t nmiFlags)
{
    ...
    //
    HWREG(NMI_BASE + NMI_O_FLGCLR) = nmiFlags;
    HWREG(NMI_BASE + NMI_O_FLGCLR) = NMI_FLG_NMIINT;
...
SysCtl_forceNMIFlags(uint32_t nmiFlags)
{
    ...
    // force register
    //
    HWREG(NMI_BASE + NMI_O_FLGFRC) |= nmiFlags;
...
SysCtl_getNMIWatchdogCounter(void)
{
    ...
    //
    return(HWREG(NMI_BASE + NMI_O_WDCNT));
}
...
//*****************************************************************************
static __always_inline void
SysCtl_setNMIWatchdogPeriod(uint32_t wdPeriod)
{
    EALLOW;
    ...
    //
    HWREG(NMI_BASE + NMI_O_WDPRD) = wdPeriod;
...
SysCtl_getNMIWatchdogPeriod(void)
{
    ...
    //
    return(HWREG(NMI_BASE + NMI_O_WDPRD));
}
...
SysCtl_getNMIShadowFlagStatus(void)
{
    ...
    //
    return(HWREG(NMI_BASE + NMI_O_SHDFLG));
}
...
SysCtl_isNMIShadowFlagSet(uint32_t nmiFlags)
{
    ...
    // Read the flag register and return true if any of them are set.
    //
    return((HWREG(NMI_BASE + NMI_O_SHDFLG) & nmiFlags) != 0U);
}
...
SysCtl_enableMCD(void)
{
    ...
    HWREG(CLKCFG_BASE + SYSCTL_O_MCDCR) &= ~(SYSCTL_MCDCR_MCLKOFF);
...
SysCtl_isMCDClockFailureDetected(void)
{
    ...
    //
    return((HWREG(CLKCFG_BASE + SYSCTL_O_MCDCR) & SYSCTL_MCDCR_MCLKSTS) != 0U);
}
...
SysCtl_resetMCD(void)
{
    ...
    HWREG(CLKCFG_BASE + SYSCTL_O_MCDCR) |= SYSCTL_MCDCR_MCLKCLR;
...
SysCtl_connectMCDClockSource(void)
{
    ...
    HWREG(CLKCFG_BASE + SYSCTL_O_MCDCR) &= ~(SYSCTL_MCDCR_OSCOFF);
...
SysCtl_lockAccessControlRegs(void)
{
    ...
    HWREG(PERIPHAC_BASE + SYSCTL_O_PERIPH_AC_LOCK) |=
                                  ...
                                  SysCtl_AccessPermission permission)
{
    ...
    HWREG(PERIPHAC_BASE + (uint32_t)peripheral) =
        (HWREG(PERIPHAC_BASE + (uint32_t)peripheral) &
         ~(0x3U << (uint32_t)controller)) |
        ((uint32_t)permission << (uint32_t)controller);
													...
													SysCtl_AccessController controller)
{
    ...
    // two bits dedicated to its permission setting.
    //
    return((HWREG(PERIPHAC_BASE + (uint32_t)peripheral) >> (uint32_t)controller) &
           0x3U);
}
...
{
    return(HWREG(DEVCFG_BASE + SYSCTL_O_FUSEERR));
}
...
SysCtl_setXClk(SysCtl_XClkDivider divider)
{
    ...
    //
    EALLOW;
    HWREG(CLKCFG_BASE + SYSCTL_O_XCLKOUTDIVSEL) =
                        (HWREG(CLKCFG_BASE + SYSCTL_O_XCLKOUTDIVSEL) &
...
//*****************************************************************************
static __always_inline void
SysCtl_setPLLSysClk(uint32_t divider)
{
    //
    // Clears the divider then configures it.
    //
                               ...
                               SysCtl_Cputimer2ClkSource source)
{
  //
    ...
    HWREG(CPUSYS_BASE + SYSCTL_O_TMR2CLKCTL) |=
                    ((uint32_t)divider << SYSCTL_TMR2CLKCTL_TMR2CLKPRESCALE_S) |
                    ((uint32_t)source << SYSCTL_TMR2CLKCTL_TMR2CLKSRCSEL_S);
    EDIS;
}
    ...
    HWREG(CLKCFG_BASE + SYSCTL_O_CLBCLKCTL) =
                        (HWREG(CLKCFG_BASE + SYSCTL_O_CLBCLKCTL) &
                         ~(SYSCTL_CLBCLKCTL_CLBCLKDIV_M |
                           SYSCTL_CLBCLKCTL_TILECLKDIV | (0x1U << inst)));
...
{
    return((HWREG(NMI_BASE + NMI_O_ERRORSTS) & NMI_ERRORSTS_ERROR) != 0U);
}
...
SysCtl_getErrorPinStatus(void)
{
    ...
    //
    return((HWREG(NMI_BASE + NMI_O_ERRORSTS) & NMI_ERRORSTS_PINSTS) != 0U);
}
...
{
    EALLOW;
    HWREG(NMI_BASE + NMI_O_ERRORSTSFRC) |= NMI_ERRORSTSFRC_ERROR;
    EDIS;
}
...
{
    EALLOW;
    HWREG(NMI_BASE + NMI_O_ERRORSTSCLR) |= NMI_ERRORSTSCLR_ERROR;
    EDIS;
}
...
//*****************************************************************************
static __always_inline void
SysCtl_selectErrPinPolarity(uint32_t pol)
{
    EALLOW;
    //
    ...
    if(pol == 1U)
    {
        HWREG(NMI_BASE + NMI_O_ERRORCTL) |= NMI_ERRORCTL_ERRORPOLSEL;
    }
    else
    {
        HWREG(NMI_BASE + NMI_O_ERRORCTL) &= ~NMI_ERRORCTL_ERRORPOLSEL;
