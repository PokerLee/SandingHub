...
//! return flags for both Controller and non-Controller access violations although only
//! the non-Controller flags have the ability to cause the generation of an
//! interrupt.
//!
