...
//*****************************************************************************
//
// APIs macro definition.
//
//*****************************************************************************

#define    Fapi_initializeAPI             (void (*)(uint32 u32HclkFrequency))0x7fa900
#define    UserOTP_Program                                          \
	(Uint16 (*)(Uint32 *FlashAddr,Uint32 *BufAddr,Uint32 Lenghth,    \
                  Uint32 *OTPTempBuffer, Uint8 zone, void *param))0x7fb0bc
...
//*****************************************************************************
//
//! Program user OTP Zone1 Block Configuration
//!
//! \param block is the block which the user wants to program
//!
//! \param userOtpData is The data content that the user wants to program is
//!  limited to 8 32-bit arrays
//!
//! \Returns true if was successful the status of user OTP Zone1 program
//
//*****************************************************************************

extern uint32
DCSM_modifyZone1BlockConfig(uint32_t block,uint32_t * userOtpData);

//*****************************************************************************
//
//! Program user OTP Zone2 Block Configuration
//!
//! \param block is the block which the user wants to program
//!
//! \param userOtpData is The data content that the user wants to program is
//!  limited to 8 32-bit arrays
//!
//! \Returns true if was successful the status of user OTP Zone2 program
//
//*****************************************************************************

extern uint32
DCSM_modifyZone2BlockConfig(uint32_t block,uint32_t * userOtpData);
