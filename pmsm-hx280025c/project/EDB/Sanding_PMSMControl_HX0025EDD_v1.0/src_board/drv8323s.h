...
//
//*****************************************************************************
extern DRV8323_CTRL03_PeakSourCurHS_e DRV8323_getPeakSourCurHS(DRV8323_Handle handle);

//*****************************************************************************
//
//! \brief     获取DRV8323高侧栅极驱动峰值吸收电流值
//!
//! \param[in] handle  DRV8323结构体指针
//!
//! \return    高侧栅极驱动峰值吸收电流
//
//*****************************************************************************
extern DRV8323_CTRL03_PeakSinkCurHS_e DRV8323_getPeakSinkCurHS(DRV8323_Handle handle);

//*****************************************************************************
//
//! \brief     获取DRV8323低侧栅极驱动峰值源极电流时间
//!
//! \param[in] handle  DRV8323结构体指针
//!
//! \return    低侧栅极驱动峰值源极电流时间
//
//*****************************************************************************
extern DRV8323_CTRL04_PeakTime_e DRV8323_getPeakSourTime(DRV8323_Handle handle);

//*****************************************************************************
//
//! \brief     获取DRV8323低侧栅极驱动峰值源极电流值
//!
//! \param[in] handle  DRV8323结构体指针
//!
//! \return    低侧栅极驱动峰值源极电流
//
//*****************************************************************************
extern DRV8323_CTRL04_PeakSourCurLS_e DRV8323_getPeakSourCurLS(DRV8323_Handle handle);

//*****************************************************************************
//
//! \brief     获取DRV8323低侧栅极驱动峰值吸收电流值
//!
//! \param[in] handle  DRV8323结构体指针
//!
//! \return    低侧栅极驱动峰值吸收电流
//
//*****************************************************************************
extern DRV8323_CTRL04_PeakSinkCurLS_e DRV8323_getPeakSinkCurLS(DRV8323_Handle handle);

//*****************************************************************************
//
//! \brief     获取DRV8323OCP/VDS感测延迟时间
//!
//! \param[in] handle  DRV8323结构体指针
//!
//! \return    OCP/VDS感测延迟时间
//
//*****************************************************************************
extern DRV8323_CTRL05_OcpDeg_e DRV8323_getVDSDeglitch(DRV8323_Handle handle);
...
//
//*****************************************************************************
extern DRV8323_CTRL05_DeadTime_e DRV8323_getDeadTime(DRV8323_Handle handle);

//*****************************************************************************
//
//! \brief     获取DRV8323 PWM输入模式
//!
//! \param[in] *pMemory  DRV8323结构体指针
//!
//! \return    PWM输入模式
//
//*****************************************************************************
extern DRV8323_CTRL02_PWMMode_e DRV8323_getPWMMode(DRV8323_Handle handle);
...
//! \param[in] handle	  DRV8323结构体指针
//!
//! \param[in] spiHandle  spiHandle结构体存储地址
//
//*****************************************************************************
extern void DRV8323_setSPIHandle(DRV8323_Handle handle, uint32_t spiHandle);
...
//! \param[in] handle	  DRV8323结构体指针
//!
//! \param[in] gpioNumber CS引脚IO端口号
//
//*****************************************************************************
extern void DRV8323_setGPIOCSNumber(DRV8323_Handle handle, uint32_t gpioNumber);

//*****************************************************************************
//
//! \brief     设定DRV8323使能引脚IO端口号
//!
//! \param[in] handle	  DRV8323结构体指针
//!
//! \param[in] gpioNumber DRV8323使能引脚IO端口号
//
//*****************************************************************************
extern void DRV8323_setGPIOENNumber(DRV8323_Handle handle, uint32_t gpioNumber);
...
//! \param[in] handle	  	DRV8323结构体指针
//!
//! \param[in] *drv8323Vars DRV8323寄存器结构体变量
//
//*****************************************************************************
extern void DRV8323_setupSPI(DRV8323_Handle handle, DRV8323_VARS_t *drv8323Vars);
...
//! \param[in] regAddr		DRV8323寄存器地址
//!
//! \param[in] data			写入DRV8323寄存器的数据
//!
//! \return    DRV8323寄存器值
//
//*****************************************************************************
extern void DRV8323_writeSPI(DRV8323_Handle handle, const DRV8323_Address_e regAddr,
                      const uint16_t data);
...
//! \param[in] handle	  	DRV8323结构体指针
//!
//! \param[in] drv8323Vars	DRV8323寄存器结构体指针
//
//*****************************************************************************
extern void DRV8323_writeData(DRV8323_Handle handle, DRV8323_VARS_t *drv8323Vars);
...
//
//*****************************************************************************
extern void DRV8323_readData(DRV8323_Handle handle, DRV8323_VARS_t *drv8323Vars);
