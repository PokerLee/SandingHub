...
#define PMBUS_SYS_FREQ_MAX      160000000UL
...
extern const uint32_t PMBus_crc8Table[256U];
...
//
//*****************************************************************************
static __always_inline void PMBus_disableModule(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_enableModule(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_enableInterrupt(uint32_t base, uint32_t intFlags)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_disableInterrupt(uint32_t base, uint32_t intFlags)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline bool PMBus_isBusBusy(uint32_t status)
{
...
//
//*****************************************************************************
static __always_inline bool PMBus_isPECValid(uint32_t status)
{
...
//
//*****************************************************************************
static __always_inline void PMBus_enableI2CMode(uint32_t base)
{
    //
    // Locals
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_disableI2CMode(uint32_t base)
{
    //
    // Locals
    //
...
//
//*****************************************************************************
static __always_inline uint32_t PMBus_getStatus(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_ackTransaction(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_nackTransaction(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_assertAlertLine(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_deassertAlertLine(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_configController(uint32_t base, uint32_t targetAddress,
                               uint32_t byteCount, uint32_t configWord)
{
    //
    // Locals
...
//
//*****************************************************************************
static __always_inline uint32_t PMBus_getOwnAddress(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_setOwnAddress(uint32_t base, uint32_t Ownaddress)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_setTargetAddress(uint32_t base, uint32_t targetAddress)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline PMBus_accessType PMBus_getCurrentAccessType(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static __always_inline void PMBus_setCtrlIntEdge(uint32_t base, PMBus_intEdge intEdge)
{
    //
    // Check the arguments.
    //
...
//*****************************************************************************
extern
void PMBus_initTargetMode(uint32_t base, uint32_t address, uint32_t mask);
...
//*****************************************************************************
extern uint32_t
PMBus_getData(uint32_t base, uint32_t *buffer, uint32_t status);
...
//*****************************************************************************
extern void
PMBus_putTargetData(uint32_t base, uint32_t *buffer, uint32_t nBytes,
                   bool txPEC);
...
//
//*****************************************************************************
extern void PMBus_generateCRCTable(uint32_t *crcTable);
...
//
//*****************************************************************************
extern bool PMBus_verifyPEC(uint32_t base, uint32_t *buffer,
                  const uint32_t *crcTable, uint32_t byteCount, uint32_t pec);
...
//*****************************************************************************
extern void
PMBus_putControllerData(uint32_t base, uint32_t *buffer, uint32_t nBytes);
