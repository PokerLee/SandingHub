...
#define GPIO_GPxAMSEL_INDEX     (0x00000028U / 4U) // Address rsvd for GPAAMSEL
...
typedef enum
{
    ...
    GPIO_INT_XINT2 = 4,                     //!< External Interrupt 2
    GPIO_INT_XINT3 = 8,                     //!< External Interrupt 3
    GPIO_INT_XINT4 = 12,                     //!< External Interrupt 4
    GPIO_INT_XINT5 = 16                      //!< External Interrupt 5
} GPIO_ExternalIntNum;
...
GPIO_setInterruptType(GPIO_ExternalIntNum extIntNum, GPIO_IntType intType)
{
    ...
    //
    HWREG((uint32_t)(XINT_BASE + (uint32_t)extIntNum)) =
        (uint16_t)(HWREG((uint32_t)(XINT_BASE + (uint32_t)extIntNum)) & ~XINT_1CR_POLARITY_M) |
        (uint32_t)intType;
}
...
//
//*****************************************************************************
static __always_inline GPIO_IntType
GPIO_getInterruptType(GPIO_ExternalIntNum extIntNum)
{
    //
    // Read the selected polarity from the appropriate register.
    //
    return((GPIO_IntType)((uint32_t)(HWREG((uint32_t)(XINT_BASE + (uint32_t)extIntNum)) &
                          XINT_1CR_POLARITY_M)));
}
...
GPIO_enableInterrupt(GPIO_ExternalIntNum extIntNum)
{
    ...
    //
    HWREG((uint16_t)(XINT_BASE + (uint32_t)extIntNum)) |= XINT_1CR_ENABLE;
}
...
GPIO_disableInterrupt(GPIO_ExternalIntNum extIntNum)
{
    ...
    //
    HWREG((uint32_t)(XINT_BASE + (uint32_t)extIntNum)) &= ~XINT_1CR_ENABLE;
}
...
GPIO_getInterruptCounter(GPIO_ExternalIntNum extIntNum)
{
    ...
    //
    return((HWREG((uint32_t)(XINT_BASE + XINT_O_1CTR + (uint32_t)extIntNum))));
}
