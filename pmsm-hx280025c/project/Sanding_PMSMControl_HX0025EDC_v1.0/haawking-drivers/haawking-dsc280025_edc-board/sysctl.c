                  ...
                  uint32_t pllMultDiv)
{
    ...
    float  fclk1_0ratio;
    float dccCounterSeed1_div;
    float dccValidSeed0_div;
    uint32 clk0,clk1;
    ...
    switch(oscSource)
    {
        case SYSCTL_OSCSRC_OSC2:
            ...
            clk0 = DEVICE_INTOSC_FREQ/1000000;
            break;
        case SYSCTL_OSCSRC_XTAL:
        case SYSCTL_OSCSRC_XTAL_SE:
            //
            ...
            clk0 = DEVICE_OSCSRC_FREQ/1000000;
            break;
        case SYSCTL_OSCSRC_OSC1:
            //
    ...
    clk1 = (uint32_t)(fclk1_0ratio*clk0);

    dccCounterSeed0 = 5000;

    dccCounterSeed1_div  = (float)(((dccCounterSeed0+2)*(1000/clk0)*1.03 + 2*(1000/clk1)*1.1 - 2*(1000/clk1)*0.9)/((1000/clk1)*0.9));
    dccCounterSeed1_div = (float)(dccCounterSeed1_div/10);
    dccCounterSeed1 = (uint32_t)((dccCounterSeed1_div+1)*10);




    dccValidSeed0_div =( float)(((dccCounterSeed1 + 2)*(1000/clk1)*(100+10)/100 +  2*(1000/clk1)*(100+10)/100 - (2 + 5000)*(1000/clk0)*(100-3)/100)/((1000/clk0)*(100-3)/100));
    dccValidSeed0_div = ( float)(dccValidSeed0_div/10);
     dccValidSeed0 = (uint32_t)((dccValidSeed0_div+1)*10);
