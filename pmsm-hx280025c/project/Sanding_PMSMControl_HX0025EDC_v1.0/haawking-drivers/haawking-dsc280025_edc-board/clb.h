...
//
//*****************************************************************************
static inline void CLB_configureClockPrescalar(uint32_t base, uint32_t prescl)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static inline void CLB_configureStrobeMode(uint32_t base, uint32_t strb)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static inline void CLB_configHLCEventedgeSelect(uint32_t base, uint32_t eventedgeSel)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static inline void CLB_configSPIBufferLoadSignal(uint32_t base, uint32_t eventSel)
{
    ASSERT(CLB_isBaseValid(base));
...
//
//*****************************************************************************
static inline void CLB_configSPIBufferShift(uint32_t base, uint32_t shiftVal)
{
    ASSERT(CLB_isBaseValid(base));
