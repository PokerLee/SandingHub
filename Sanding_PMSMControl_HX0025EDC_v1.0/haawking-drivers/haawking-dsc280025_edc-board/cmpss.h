...
//*****************************************************************************
//
//! Values that can be passed to CMPSS_setClockPrescaler() as the
//! \e prescaler parameter.
//
//*****************************************************************************
typedef enum
{
    CMPSS_CLOCK_DIVIDER_2 = 0,     //!< Divide clock by 2
	CMPSS_CLOCK_DIVIDER_4 = 1,     //!< Divide clock by 4
	CMPSS_CLOCK_DIVIDER_6 = 2,     //!< Divide clock by 6
	CMPSS_CLOCK_DIVIDER_8 = 3,     //!< Divide clock by 8
	CMPSS_CLOCK_DIVIDER_10 = 4,    //!< Divide clock by 10
	CMPSS_CLOCK_DIVIDER_12 = 5,    //!< Divide clock by 12
	CMPSS_CLOCK_DIVIDER_14 = 6,    //!< Divide clock by 14
	CMPSS_CLOCK_DIVIDER_16 = 7     //!< Divide clock by 16
} CMPSS_ClockDivider;
...
CMPSS_enableModule(uint32_t base)
{
    ...
    HWREG(base + CMPSS_O_COMPCTL) |= CMPSS_COMPCTL_COMPDACE;
    HWREG(base + CMPSS_O_COMPHYSCTL) |= CMPSS_COMPHYSCTL_CMPSS_ENABLE;
...
//*****************************************************************************
static inline void
CMPSS_configHighComparator(uint32_t base, uint32_t config)
{
    //
    // Check the arguments.
    //
    ...
    HWREG(base + CMPSS_O_COMPCTL) =
        (HWREG(base + CMPSS_O_COMPCTL) & ~CMPSS_HICMP_CTL_M) | config;
...
//*****************************************************************************
static inline void
CMPSS_configLowComparator(uint32_t base, uint32_t config)
{
    //
    // Check the arguments.
    //
    ...
    HWREG(base + CMPSS_O_COMPCTL) =
        (HWREG(base + CMPSS_O_COMPCTL) & ~CMPSS_LOCMP_CTL_M) | (config << 8U);
...
//*****************************************************************************
static inline void
CMPSS_configOutputsHigh(uint32_t base, uint32_t config)
{
    //
    // Check the arguments.
    //
    ...
    HWREG(base + CMPSS_O_COMPCTL) = (HWREG(base + CMPSS_O_COMPCTL) &
...
//*****************************************************************************
static inline void
CMPSS_configOutputsLow(uint32_t base, uint32_t config)
{
    //
    // Check the arguments.
    //
...
CMPSS_getStatus(uint32_t base)
{
    ...
    //
    return(HWREG(base + CMPSS_O_COMPSTS));
}
...
//*****************************************************************************
static inline void
CMPSS_configDAC(uint32_t base, uint32_t config)
{
    //
    // Check the arguments.
    //
...
//*****************************************************************************
static inline void
CMPSS_setDACValueHigh(uint32_t base, uint32_t value)
{
    //
    // Check the arguments.
    //
    ...
    //
    HWREG(base + CMPSS_O_DACHVALS) = value;
}
...
//*****************************************************************************
static inline void
CMPSS_setDACValueLow(uint32_t base, uint32_t value)
{
    //
    // Check the arguments.
    //
    ...
    // Write the DAC value to the DAC value shadow register.
    //
    HWREG(base + CMPSS_O_DACLVALS) = value;
}
...
CMPSS_initFilterHigh(uint32_t base)
{
    ...
    HWREG(base + CMPSS_O_CTRIPHFILCTL) |= CMPSS_CTRIPHFILCTL_FILINIT;
...
CMPSS_initFilterLow(uint32_t base)
{
    ...
    HWREG(base + CMPSS_O_CTRIPLFILCTL) |= CMPSS_CTRIPLFILCTL_FILINIT;
...
CMPSS_getDACValueHigh(uint32_t base)
{
    ...
    // Write the DAC value to the DAC value shadow register.
    //
    return(HWREG(base + CMPSS_O_DACHVALA));
}
...
CMPSS_getDACValueLow(uint32_t base)
{
    ...
    // Write the DAC value to the DAC value shadow register.
    //
    return(HWREG(base + CMPSS_O_DACLVALA));
}
...
CMPSS_clearFilterLatchHigh(uint32_t base)
{
    ...
    HWREG(base + CMPSS_O_COMPSTSCLR) |= CMPSS_COMPSTSCLR_HLATCHCLR;
...
CMPSS_clearFilterLatchLow(uint32_t base)
{
    ...
    HWREG(base + CMPSS_O_COMPSTSCLR) |= CMPSS_COMPSTSCLR_LLATCHCLR;
...
//*****************************************************************************
static inline void
CMPSS_setMaxRampValue(uint32_t base,  uint32_t value)
{
    //
    // Check the arguments.
    //
    ...
    //
    HWREG(base + CMPSS_O_RAMPMAXREFS) = value;
}
...
CMPSS_getMaxRampValue(uint32_t base)
{
    ...
    //
    return(HWREG(base + CMPSS_O_RAMPMAXREFA));
}
...
//*****************************************************************************
static inline void
CMPSS_setRampDecValue(uint32_t base, uint32_t value)
{
    //
    // Check the arguments.
    //
    ...
    //
    HWREG(base + CMPSS_O_RAMPDECVALS) = value;
}
...
CMPSS_getRampDecValue(uint32_t base)
{
    ...
    //
    return(HWREG(base + CMPSS_O_RAMPDECVALA));
}
...
//*****************************************************************************
static inline void
CMPSS_setRampDelayValue(uint32_t base, uint32_t value)
{
    //
    // Check the arguments.
    //
    ...
    //
    HWREG(base + CMPSS_O_RAMPDLYS) = value;
}
...
CMPSS_getRampDelayValue(uint32_t base)
{
    ...
    //
    return(HWREG(base + CMPSS_O_RAMPDLYA));
}
...
CMPSS_configureSyncSource(uint32_t base, uint16_t syncSource)
{
    ...
    //
    EALLOW;
    HWREG(base + CMPSS_O_COMPDACCTL) = (HWREG(base + CMPSS_O_COMPDACCTL) &
...
//*****************************************************************************
static inline void
CMPSS_setHysteresis(uint32_t base, uint32_t value)
{
    //
    // Check the arguments.
    //
    ...
    HWREG(base + CMPSS_O_COMPHYSCTL) &= ~CMPSS_COMPHYSCTL_COMPHYS_M;
    HWREG(base + CMPSS_O_COMPHYSCTL) |= value;
...
//*****************************************************************************
static inline void
CMPSS_configBlanking(uint32_t base, uint32_t pwmBlankSrc)
{
    //
    // Check the arguments.
    //
    ...
    HWREG(base + CMPSS_O_COMPDACCTL) =
        (HWREG(base + CMPSS_O_COMPDACCTL) & ~CMPSS_COMPDACCTL_BLANKSOURCE_M) |
...
CMPSS_enableBlanking(uint32_t base)
{
    ...
    //
    EALLOW;
    HWREG(base + CMPSS_O_COMPDACCTL) |= CMPSS_COMPDACCTL_BLANKEN;
    EDIS;
}
...
//! \param base is the base address of the comparator module.
//!
//! This function set the cmpss clock
//!
//! \return None.
//
//*****************************************************************************
static inline void
CMPSS_setClockPrescaler(uint32_t base,CMPSS_ClockDivider prescaler)
{
    //
    // Check the arguments.
    //
    ...
    //
    EALLOW;
    HWREG(base + CMPSS_O_COMPCLKDIV) = prescaler;
    EDIS;
}
//*****************************************************************************
//
