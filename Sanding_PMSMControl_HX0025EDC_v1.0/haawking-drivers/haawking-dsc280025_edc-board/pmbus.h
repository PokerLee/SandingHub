...
//
//*****************************************************************************
static inline void PMBus_configController(uint32_t base, uint32_t targetAddress,
...
//
//*****************************************************************************
static inline uint32_t PMBus_getOwnAddress(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void PMBus_setOwnAddress(uint32_t base, uint32_t Ownaddress)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void PMBus_setTargetAddress(uint32_t base, uint32_t targetAddress)
{
    //
    // Check the arguments.
    //
